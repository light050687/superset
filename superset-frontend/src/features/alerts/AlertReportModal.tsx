...
const NotificationMethodAdd: FunctionComponent<
  React.PropsWithChildren<NotificationMethodAddProps>
...
const AlertReportModal: FunctionComponent<
  React.PropsWithChildren<AlertReportModalProps>
> = ({
  addDangerToast,
  onAdd,
  onHide,
