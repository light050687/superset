...
const TrendChart: React.FC<TrendChartProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Hover overlay: прозрачные rect'ы на каждый слот */}
      {paths.points.map((p, i) => (
        <rect
          key={`hit-${i}`}
          x={p.x - paths.slotW / 2}
      ...
      {/* Hover highlight: vertical guide + ring */}
      {hover && (
        <>
          <line
            x1={hover.x}
