...
const isDrillEnabled = ({ controls }: ControlsMap): boolean =>
  controls?.enable_drill_modal?.value === true;
        ...
        [
          {
            ...
            config: {
              ...
              label: t('Подпись (sub)'),
              description: t(
                'Дополнительная колонка с подписью под названием — например «Молочка, хлеб».',
              ),
              multi: false,
              required: false,
            },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Колонка датасета со значениями: clock | thermometer | shield | triangle | package. ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Колонка со значениями вида --c-sky, --c-violet, --c-tangerine, --c-fuchsia, --c-amber. ' +
        ...
        [
          {
            ...
            config: {
              ...
              default: 30,
              description: t(
                'Сколько строк запрашивать у БД. В карточке показываются только первые top_n_visible; ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Сколько верхних строк показывать в компактном виде. ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Показывается перед периодом в подзаголовке. ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Миниграфик тренда в каждой строке. Требует дополнительного time-series запроса.',
              ),
              default: true,
              renderTrigger: true,
            },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Пунктирный прямоугольник позади основного бара показывает значение прошлого периода.',
              ),
              default: true,
              renderTrigger: true,
            },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Если включено, рост значения подсвечивается красным (dn), снижение — зелёным (up). ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Открывает окно с топ-магазинов / топ-SKU / трендом 12 недель по выбранной категории.',
              ),
              default: true,
              renderTrigger: true,
            },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Добавляет ссылку в футере, открывающую полный список всех строк с поиском и сортировкой.',
              ),
              default: true,
              renderTrigger: true,
            },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Обычный клик по строке переключает фильтр в выбранном измерении на других чартах дашборда.',
              ),
              default: true,
              renderTrigger: true,
            },
