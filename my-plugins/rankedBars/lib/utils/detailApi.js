...
exports.fetchDrillData = fetchDrillData;
 ...
 */
async function fetchDrillData(queryParams, rowId, signal) {
    const metricLabel = (0, core_1.getMetricLabel)(queryParams.metric);
    ...
    const skusPromise = skuDim
        ...
        : Promise.resolve([]);
    const trendPromise = core_1.SupersetClient.post({
        endpoint: 'api/v1/chart/data',
