...
export declare const LIGHT_TOKENS: {
    ...
    readonly sh: "0 1px 2px rgba(15, 17, 20, 0.08)";
    readonly shLg: "0 12px 32px rgba(15, 17, 20, 0.18)";
    readonly shModal: "0 24px 60px rgba(15, 17, 20, 0.2)";
    readonly mBg: "rgba(15, 17, 20, 0.4)";
};
export declare const DARK_TOKENS: {
    ...
    readonly onAccent: "#ffffff";
    readonly sh: "0 1px 2px rgba(0, 0, 0, 0.4)";
    readonly shLg: "0 12px 32px rgba(0, 0, 0, 0.55)";
    readonly shModal: "0 24px 60px rgba(0, 0, 0, 0.5)";
    readonly mBg: "rgba(0, 0, 0, 0.5)";
};
...
export declare const EASE = "cubic-bezier(0.2, 0.8, 0.25, 1)";
/** Categorical palette order — first 5 rows get accent colors, rest default to g500. */
export declare const CATEGORICAL_TOKENS: readonly ["--c-sky", "--c-tangerine", "--c-fuchsia", "--c-amber", "--c-violet"];
