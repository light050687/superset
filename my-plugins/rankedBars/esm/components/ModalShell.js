...
const ModalShell = ({ open, onClose, wide = false, themeMode, zIndex, labelledBy, children, }) => {
    ...
    if (!open || typeof document === 'undefined')
        return null;
    return createPortal(_jsx(ModalBackdrop, { "data-theme": themeMode, "$zIndex": zIndex, onClick: e => {
            if (e.target === e.currentTarget)
                onClose();
        }, children: _jsx(ModalBox, { ref: boxRef, role: "dialog", "aria-modal": "true", "aria-labelledby": labelledBy, "$wide": wide, children: children }) }), document.body);
};
