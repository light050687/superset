...
const TrendChart = ({ data, color, height = 90, labelBuilder = DEFAULT_LABEL, }) => {
    ...
    return (_jsxs("svg", { width: "100%", height: paths.h, viewBox: `0 0 ${paths.w} ${paths.h}`, preserveAspectRatio: "none", overflow: "visible", "aria-hidden": "true", children: [_jsx("defs", { children: _jsxs("linearGradient", { id: gradId, x1: "0", y1: "0", x2: "0", y2: "1", children: [_jsx("stop", { offset: "0%", stopColor: color, stopOpacity: 0.3 }), _jsx("stop", { offset: "100%", stopColor: color, stopOpacity: 0.02 })] }) }), _jsx("line", { x1: 8, y1: paths.h - paths.padB, x2: paths.w - 8, y2: paths.h - paths.padB, stroke: "var(--g200)", strokeWidth: 1 }), _jsx("path", { d: paths.areaPath, fill: `url(#${gradId})` }), _jsx("path", { d: paths.linePath, fill: "none", stroke: color, strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round" }), paths.points.map((p, i) => (_jsx("circle", { cx: p.x, cy: p.y, r: p.last ? 3.5 : 1.8, fill: color, stroke: "var(--s)", strokeWidth: p.last ? 1.5 : 1 }, i))), paths.labels.map((l, i) => (_jsx("text", { x: l.x, y: paths.h - 4, fontFamily: "JetBrains Mono, monospace", fontSize: "9", fontWeight: "500", fill: "var(--g500)", textAnchor: "middle", letterSpacing: "0.5", children: l.label }, i)))] }));
};
