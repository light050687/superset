...
import { EXPENSES_PRESET, LOSSES_PRESET, parseCustomMockJson, } from '../mocks/presets';
// ─────────────────────────────────────────────────────────────────────────────
// Helpers
// ─────────────────────────────────────────────────────────────────────────────
...
export default function transformProps(chartProps) {
    ...
    const rawMappedRows = rawRows
        ...
        const iconName = resolveIcon(iconCol ? row[iconCol] : undefined);
        const colorToken = normalizeColorToken(colorCol ? row[colorCol] : undefined, idx);
