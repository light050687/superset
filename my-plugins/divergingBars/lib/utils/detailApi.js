...
exports.buildStoresPayload = buildStoresPayload;
exports.buildStoresCountPayload = buildStoresCountPayload;
exports.extractApiRows = extractApiRows;
exports.extractApiCompRows = extractApiCompRows;
const core_1 = require("@superset-ui/core");
const rowsToStores_1 = require("./rowsToStores");
 ...
 */
function buildStoresPayload(params) {
    ...
    const shift = !isCustom ? (0, rowsToStores_1.comparisonModeToShift)(mode) : '';
 ...
 */
function buildStoresCountPayload(params) {
...
function extractApiCompRows(json) {
    const resultArr = json.result;
