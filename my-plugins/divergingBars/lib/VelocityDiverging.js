...
const VelocityDiverging = ({ width, height, headerText, subtitleText, dataState, partialWarning, errorMessage, stores: inputStores, formats: inputFormats, defaultHorizon, defaultMetric, showCumulativeView, showDetailModal, showCsvExport, showSummaryStrip, isDarkMode, }) => {
    ...
    if (dataState === 'error') {
        return ((0, jsx_runtime_1.jsx)(styles_1.VelocityRoot, { ...rootProps, children: (0, jsx_runtime_1.jsx)("div", { className: "vd-card", children: (0, jsx_runtime_1.jsxs)("div", { className: "vd-state error", role: "alert", "aria-live": "assertive", children: [(0, jsx_runtime_1.jsx)(IconError, {}), (0, jsx_runtime_1.jsx)("div", { className: "vd-state-message", children: errorMessage || (0, core_1.t)('Не удалось загрузить данные.') }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "vd-state-action", onClick: () => window.location.reload(), children: (0, core_1.t)('Повторить') })] }) }) }));
    }
    /* Loading state (DS 2.0 §08: skeleton 0.8s, aria-busy). */
    if (dataState === 'loading') {
        return ((0, jsx_runtime_1.jsx)(styles_1.VelocityRoot, { ...rootProps, children: (0, jsx_runtime_1.jsxs)("div", { className: "vd-card", "aria-busy": "true", "aria-live": "polite", children: [(0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { variant: "title" }), (0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { variant: "header" }), (0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { variant: "row" }), (0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { variant: "row" }), (0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { variant: "row" }), (0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { variant: "row" })] }) }));
    }
    /* Empty state (DS 2.0 §08: иконка 48×48 --g300 + текст + предложение). */
    if (dataState === 'empty') {
        return ((0, jsx_runtime_1.jsx)(styles_1.VelocityRoot, { ...rootProps, children: (0, jsx_runtime_1.jsxs)("div", { className: "vd-card", children: [(0, jsx_runtime_1.jsx)("h2", { className: "vd-title", children: headerText }), (0, jsx_runtime_1.jsxs)("div", { className: "vd-state", role: "status", children: [(0, jsx_runtime_1.jsx)(IconEmpty, {}), (0, jsx_runtime_1.jsx)("div", { className: "vd-state-message", children: (0, core_1.t)('Нет данных для отображения.') }), (0, jsx_runtime_1.jsx)("div", { className: "vd-state-hint", children: (0, core_1.t)('Попробуйте изменить фильтры или расширить диапазон дат.') })] })] }) }));
    }
