...
const VelocityDiverging = ({ width, height, headerText, subtitleText, dataState, partialWarning, errorMessage, stores: inputStores, formats: inputFormats, defaultHorizon, defaultMetric, showCumulativeView, showDetailModal, showCsvExport, showSummaryStrip, isDarkMode, }) => {
    ...
    if (dataState === 'empty') {
        return ((0, jsx_runtime_1.jsx)(styles_1.VelocityRoot, { ...rootProps, children: (0, jsx_runtime_1.jsxs)("div", { className: "vd-card", "data-info-hint-container": "", "data-no-anim": "", children: [(0, jsx_runtime_1.jsx)("h2", { className: "vd-title", children: headerText }), (0, jsx_runtime_1.jsxs)("div", { className: "vd-state", role: "status", children: [(0, jsx_runtime_1.jsx)(IconEmpty, {}), (0, jsx_runtime_1.jsx)("div", { className: "vd-state-message", children: (0, core_1.t)('Нет данных для отображения.') }), (0, jsx_runtime_1.jsx)("div", { className: "vd-state-hint", children: (0, core_1.t)('Попробуйте изменить фильтры или расширить диапазон дат.') })] })] }) }));
    }
