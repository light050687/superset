...
const VelocityDiverging = ({ width, height, headerText, dataState, partialWarning, errorMessage, stores: inputStores, formats: inputFormats, defaultHorizon, defaultMetric, showCumulativeView, showDetailModal, showCsvExport, showSummaryStrip, isDarkMode, }) => {
    ...
    if (dataState === 'loading') {
        return ((0, jsx_runtime_1.jsx)(styles_1.VelocityRoot, { ...rootProps, children: (0, jsx_runtime_1.jsxs)("div", { className: "vd-card", "aria-busy": "true", "aria-live": "polite", children: [(0, jsx_runtime_1.jsx)("div", { className: "vd-skeleton", style: { height: 18, width: '40%' } }), (0, jsx_runtime_1.jsx)("div", { className: "vd-skeleton", style: { height: 58, width: '100%' } }), (0, jsx_runtime_1.jsx)("div", { className: "vd-skeleton", style: { height: 42, width: '100%' } }), (0, jsx_runtime_1.jsx)("div", { className: "vd-skeleton", style: { height: 42, width: '100%' } }), (0, jsx_runtime_1.jsx)("div", { className: "vd-skeleton", style: { height: 42, width: '100%' } }), (0, jsx_runtime_1.jsx)("div", { className: "vd-skeleton", style: { height: 42, width: '100%' } })] }) }));
    }
