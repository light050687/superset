...
const VelocityDiverging = ({ width, height, headerText, subtitleText, dataState, partialWarning, errorMessage, stores: inputStores, formats: inputFormats, defaultHorizon, defaultMetric, showCumulativeView, showDetailModal, showCsvExport, showSummaryStrip, isDarkMode, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(VelocityRoot, { ...rootProps, role: "region", "aria-label": headerText, children: _jsxs("div", { className: "vd-card", "data-info-hint-container": "", children: [_jsxs("div", { className: "vd-head", children: [_jsxs("div", { className: "vd-title-block", children: [_jsx("h2", { className: "vd-title", children: headerText }), _jsxs("div", { className: "vd-sub", children: [subtitleText && (_jsxs(_Fragment, { children: [_jsx("span", { children: subtitleText }), _jsx("span", { className: "vd-dot", "aria-hidden": "true" })] })), _jsxs("span", { "aria-live": "polite", children: [summary.storesCount, " ", t('из'), " ", inputStores.length, " ", t('магазинов')] }), _jsx("span", { className: "vd-dot", "aria-hidden": "true" }), _jsx("span", { children: activePeriodLabel }), _jsx("span", { className: "vd-dot", "aria-hidden": "true" }), _jsx("span", { children: t('Ранжирование по темпу') })] })] }), _jsxs("div", { className: "vd-controls", children: [_jsx("div", { className: "vd-seg", role: "group", "aria-label": t('Метрика'), children: ['rub', 'pct'].map(m => (_jsx("button", { type: "button", "aria-pressed": metric === m, className: metric === m ? 'on' : undefined, onClick: () => setMetric(m), children: m === 'rub' ? t('₽ Суммы') : t('% к ТО') }, m))) }), _jsx("div", { className: "vd-seg", role: "group", "aria-label": t('Горизонт'), children: ALL_HORIZONS.filter(h => availableHorizons.includes(h.id)).map(h => (_jsx("button", { type: "button", "aria-pressed": horizon === h.id, className: horizon === h.id ? 'on' : undefined, onClick: () => setHorizon(h.id), children: h.label }, h.id))) }), _jsxs("div", { className: "vd-dd-wrap", children: [_jsxs("button", { type: "button", className: "vd-dd-trigger", "aria-haspopup": "true", "aria-expanded": fmtDdOpen, onClick: () => setFmtDdOpen(v => !v), children: [_jsx("svg", { viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", "aria-hidden": "true", children: _jsx("path", { d: "M2 4 L6 8 L10 4" }) }), _jsx("span", { children: t('Форматы') }), formatFilters.size > 0 && (_jsx("span", { className: "vd-count-badge", children: formatFilters.size }))] }), _jsx("div", { className: "vd-dd-menu", "data-open": fmtDdOpen, role: "menu", "aria-label": t('Форматы магазинов'), children: formats.map(f => {
                                    ...
                                    return (_jsxs("button", { type: "button", className: `vd-chip${dirFilter === c.id ? ' on' : ''}`, "aria-pressed": dirFilter === c.id, style: chipStyle, onClick: () => setDirFilter(c.id), children: [_jsx("span", { className: "vd-chip-dot", "aria-hidden": "true" }), c.label] }, c.id));
                                            ...
                                            }, onBlur: hideTooltip }, x.store.id)))] })] })), _jsxs("div", { className: "vd-footer", children: [_jsxs("div", { className: "vd-hint", children: [_jsxs("div", { className: "vd-legend-item", children: [_jsx("span", { className: "vd-sw", style: { background: palette.dn }, "aria-hidden": "true" }), _jsx("span", { children: t('рост потерь') })] }), _jsxs("div", { className: "vd-legend-item", children: [_jsx("span", { className: "vd-sw", style: { background: palette.up }, "aria-hidden": "true" }), _jsx("span", { children: t('снижение') })] })] }), _jsxs("div", { "aria-live": "polite", children: [t('Показано'), ' ', _jsx("span", { className: "vd-total-right", children: filteredStores.length }), ' ', t('из'), ' ', _jsx("span", { className: "vd-total-right", children: inputStores.length })] }), _jsx(InfoHintCorner, { children: _jsxs(InfoHint, { ariaLabel: "\u041F\u043E\u0434\u0441\u043A\u0430\u0437\u043A\u0430 \u043F\u043E \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044E", children: [_jsx("span", { className: "hi", children: _jsx("span", { children: "Click \u2014 \u043A\u0440\u043E\u0441\u0441-\u0444\u0438\u043B\u044C\u0442\u0440" }) }), showDetailModal && (_jsxs(_Fragment, { children: [_jsx("span", { className: "hi-sep", "aria-hidden": "true" }), _jsx("span", { className: "hi", children: _jsx("span", { children: "Ctrl+Click \u2014 \u0434\u0435\u0442\u0430\u043B\u0438\u0437\u0430\u0446\u0438\u044F" }) })] })), _jsx("span", { className: "hi-sep", "aria-hidden": "true" }), _jsx("span", { className: "hi", children: _jsx("span", { children: "Esc \u2014 \u0437\u0430\u043A\u0440\u044B\u0442\u044C" }) }), _jsx("span", { className: "hi-sep", "aria-hidden": "true" }), _jsx("span", { className: "hi", children: _jsx("span", { children: "Right Click \u2014 \u043C\u0435\u043D\u044E \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0439" }) })] }) })] })] }) }), tooltip && typeof document !== 'undefined' &&
