...
const VelocityDiverging = ({ width, height, headerText, subtitleText, dataState, partialWarning, errorMessage, stores: inputStores, formats: inputFormats, defaultHorizon, defaultMetric, showCumulativeView, showDetailModal, showCsvExport, showSummaryStrip, isDarkMode, }) => {
    ...
    if (dataState === 'loading') {
        return (_jsx(VelocityRoot, { ...rootProps, children: _jsxs("div", { className: "vd-card", "aria-busy": "true", "aria-live": "polite", children: [_jsx(SkeletonBlock, { variant: "title" }), _jsx(SkeletonBlock, { variant: "header" }), _jsx(SkeletonBlock, { variant: "row" }), _jsx(SkeletonBlock, { variant: "row" }), _jsx(SkeletonBlock, { variant: "row" }), _jsx(SkeletonBlock, { variant: "row" })] }) }));
    }
