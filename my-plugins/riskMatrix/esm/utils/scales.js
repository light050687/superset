...
export function pickStep(range, targetTicks) {
    if (range <= 0)
        return 1;
...
export function formatStep(v, step) {
 ...
 */
export function radius(rev, minSize, maxSize) {
...
export function randNormal(rng, mean, sd) {
