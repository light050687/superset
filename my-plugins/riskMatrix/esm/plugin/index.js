 ...
 */
export default class SupersetPluginChartRiskMatrix extends ChartPlugin {
    constructor() {
        super({
            buildQuery,
            controlPanel,
            ...
            metadata: new ChartMetadata({
                ...
                description: t('Scatter-plot матрица рисков с 4 квадрантами, zoom/pan, lasso-выделением ' +
