        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Уникальный идентификатор магазина (например, store_code). ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Определяет цвет точки. Обычно формат магазина (экспресс, минимаркет…).',
              ),
              multi: false,
              validators: [],
            },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Размер пузыря. Если не задано — все точки одинакового размера.',
              ),
              validators: [],
            },
          },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Плановое значение X по строке. Используется для bullet charts и порогов. ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Отображается в аннотациях квадрантов и summary модалей.',
              ),
              validators: [],
            },
          },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Ctrl+Click по точке открывает модаль магазина, Ctrl+Click по квадранту — модаль квадранта.',
              ),
              default: true,
              renderTrigger: true,
            },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Тот же или другой датасет для запросов trend/causes/skus. Оставить пустым — модали покажут только базовые данные.',
              ),
              default: '',
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Название временной колонки в датасете деталей. По умолчанию — недельная группировка.',
              ),
              default: '',
              visibility: isDrillEnabled,
            },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Имя колонки с категорией причин (например, reason_name). Топ-N по причинам.',
              ),
              default: '',
              visibility: isDrillEnabled,
            },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'По умолчанию — то же, что «Измерение: формат». По какой группе считать место магазина.',
              ),
              default: '',
              visibility: isDrillEnabled,
            },
