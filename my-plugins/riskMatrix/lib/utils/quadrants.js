...
exports.getQuadrantStats = getQuadrantStats;
exports.storeBadness = storeBadness;
exports.getWorstN = getWorstN;
exports.computeWeightedAverage = computeWeightedAverage;
exports.computeAverage = computeAverage;
/** Определить квадрант точки относительно порогов */
function getQuadrant(store, t) {
    const x = store.x;
    const y = store.y;
    if (x >= t.x && y >= t.y)
        return 'tr';
...
function getQuadrantStats(stores, t) {
    const stats = {
        tl: { count: 0, loss: 0 },
        tr: { count: 0, loss: 0 },
        bl: { count: 0, loss: 0 },
