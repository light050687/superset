 ...
 */
function formatRussianSmart(value) {
 ...
 */
function formatRussianSmartEx(value, decimals = -1, suffix = '') {
 ...
 */
function formatRussianPercent(ratio, signed = false) {
    const pct = ratio * 100;
 ...
 */
function formatRussianPP(ratio) {
    const pp = ratio * 100;
 ...
 */
function formatDeltaByFormat(diff, ref, fmt, isRatioSpace = false, suffixOverride) {
