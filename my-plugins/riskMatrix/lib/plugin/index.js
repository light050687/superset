 ...
 */
class SupersetPluginChartRiskMatrix extends core_1.ChartPlugin {
    constructor() {
        super({
            buildQuery: buildQuery_1.default,
            controlPanel: controlPanel_1.default,
            loadChart: () => Promise.resolve().then(() => __importStar(require('../ScatterRisk'))),
            metadata: new core_1.ChartMetadata({
                name: '[MRTS] Risk Matrix',
                description: (0, core_1.t)('Scatter-plot матрица рисков с 4 квадрантами, zoom/pan, lasso-выделением ' +
                    'и модалями детализации. Design System v2.0.'),
                thumbnail: thumbnail_png_1.default,
                tags: ['MRTS', (0, core_1.t)('Scatter'), (0, core_1.t)('Bubble'), (0, core_1.t)('Risk'), (0, core_1.t)('Correlation'), (0, core_1.t)('Featured')],
                category: 'MRTS',
            }),
...
exports.default = SupersetPluginChartRiskMatrix;
