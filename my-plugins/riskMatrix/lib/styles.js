 ...
 */
exports.PortalRoot = core_1.styled.div `
  &[data-theme='dark'] {
    ${(0, exports.themeVars)(themeTokens_1.DARK_TOKENS)}
  }
  &[data-theme='light'] {
    ${(0, exports.themeVars)(themeTokens_1.LIGHT_TOKENS)}
  }
  font-family: var(--f);
`;
...
exports.ToolbarRow = core_1.styled.div `
  display: inline-flex;
  align-items: center;
  gap: 6px;
`;
...
exports.SelectDdMenu = core_1.styled.div `
  display: flex;
  flex-direction: column;
  width: 100%;
...
`;
exports.QuadAnnot = core_1.styled.button `
 ...
 */
exports.OverlapList = core_1.styled.div `
  position: fixed;
  background: var(--s);
  border: 1px solid var(--g300);
  border-radius: 10px;
