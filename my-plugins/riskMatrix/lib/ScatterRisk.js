...
const ScatterRisk = (props) => {
    ...
    const [drillSelection, setDrillSelection] = (0, react_1.useState)(false);
    ...
    // ── Tooltip ──
    const positionTooltip = (0, react_1.useCallback)((clientX, clientY) => {
    ...
    const positionTooltipBesidePopup = (0, react_1.useCallback)((popupEl) => {
        const el = tooltipRef.current;
        if (!el)
            return;
    ...
    const showTooltipBesidePopup = (0, react_1.useCallback)((html, popupEl) => {
        const el = tooltipRef.current;
        if (!el)
            return;
        el.innerHTML = html;
    ...
    const storesById = (0, react_1.useMemo)(() => {
        const m = new Map();
    ...
    const HIT_RADIUS = 18;
    const [overlapState, setOverlapState] = (0, react_1.useState)(null);
    ...
    const overlapStateRef = (0, react_1.useRef)(overlapState);
    (0, react_1.useEffect)(() => {
        overlapStateRef.current = overlapState;
    }, [overlapState]);
    const overlapRef = (0, react_1.useRef)(null);
    const hoverStateRef = (0, react_1.useRef)({ lastId: null, lastOverlapKey: '', rafId: null, lastX: 0, lastY: 0 });
    ...
    const closeOverlap = (0, react_1.useCallback)(() => {
    ...
    const handleSvgMouseLeave = (0, react_1.useCallback)(() => {
        const state = hoverStateRef.current;
        if (state.rafId !== null) {
    ...
    if (dataState === 'loading') {
        return ((0, jsx_runtime_1.jsxs)(styles_1.CardRoot, { "data-theme": themeMode, role: "region", "aria-busy": "true", "data-no-anim": "", children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsx)(styles_1.CardHead, { children: (0, jsx_runtime_1.jsx)(styles_1.TitleBlock, { children: (0, jsx_runtime_1.jsxs)(styles_1.CardTitle, { children: [title, mockModeEnabled && (0, jsx_runtime_1.jsx)(styles_1.MockBadge, { children: "\u0422\u0415\u0421\u0422" })] }) }) }), (0, jsx_runtime_1.jsx)("div", { role: "status", "aria-label": "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430", style: { flex: 1 } })] }));
    }
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(styles_1.CardRoot, { "data-theme": themeMode, role: "region", "aria-labelledby": "sr-card-title", "data-info-hint-container": "", children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsxs)(styles_1.CardHead, { children: [(0, jsx_runtime_1.jsxs)(styles_1.TitleBlock, { children: [(0, jsx_runtime_1.jsxs)(styles_1.CardTitle, { id: "sr-card-title", children: [title, mockModeEnabled && (0, jsx_runtime_1.jsx)(styles_1.MockBadge, { children: "\u0422\u0415\u0421\u0422" }), dataState === 'partial' && ((0, jsx_runtime_1.jsx)(styles_1.PartialBadge, { title: "\u0427\u0430\u0441\u0442\u044C \u0434\u0430\u043D\u043D\u044B\u0445 \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0430", children: "\u0427\u0430\u0441\u0442\u0438\u0447\u043D\u043E" }))] }), (0, jsx_runtime_1.jsxs)(styles_1.CardSubtitle, { children: [subtitle && (0, jsx_runtime_1.jsx)("span", { children: subtitle }), subtitle && (0, jsx_runtime_1.jsx)("span", { className: "dot" }), (0, jsx_runtime_1.jsxs)("span", { className: "strong", children: [formatCount(stores.length), " \u043E\u0431\u044A\u0435\u043A\u0442\u043E\u0432"] }), activeFilters.size > 0 && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: "dot" }), (0, jsx_runtime_1.jsxs)("span", { children: [formatCount(activeFilters.size), " \u0432\u044B\u0431\u0440\u0430\u043D\u043E"] })] }))] })] }), (0, jsx_runtime_1.jsxs)(styles_1.Controls, { children: [(0, jsx_runtime_1.jsx)(Toolbar_1.default, { selectMode: selectMode, hasFilters: activeFilters.size > 0, onAction: onSelectAction, onReset: onReset, onClear: onClearFilters, onShowSelection: drillEnabled ? () => setDrillSelection(true) : undefined, searchQuery: searchQuery, onSearchChange: setSearchQuery }), (0, jsx_runtime_1.jsx)(InfoHint_1.InfoHintTopRight, { children: (0, jsx_runtime_1.jsxs)(InfoHint_1.InfoHint, { ariaLabel: "\u041F\u043E\u0434\u0441\u043A\u0430\u0437\u043A\u0430 \u043F\u043E \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044E", children: [(0, jsx_runtime_1.jsxs)("div", { className: "hint-section", children: [(0, jsx_runtime_1.jsx)("div", { className: "hint-section-title", children: "\u0423\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u0435" }), shortcutsHint.split(/\s*·\s*/).map((part, i) => {
                                                            const [keysRaw, ...descParts] = part.split(/\s*—\s*/);
                                                            const desc = descParts.join(' — ');
                                                            const keys = keysRaw.split(/\s*\+\s*/);
                                                            return ((0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [keys.map((k, ki) => ((0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("kbd", { children: k }), ki < keys.length - 1 && ' + '] }, ki))), desc && (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [" \u2014 ", desc] })] }, i));
                                                        }), (0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [(0, jsx_runtime_1.jsx)("kbd", { children: "Right Click" }), " \u2014 \u043C\u0435\u043D\u044E \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0439"] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "hint-section", children: [(0, jsx_runtime_1.jsx)("div", { className: "hint-section-title", children: "\u041F\u043E\u044F\u0441\u043D\u0435\u043D\u0438\u044F" }), (0, jsx_runtime_1.jsxs)("span", { className: "hi", children: ["\u0420\u0430\u0437\u043C\u0435\u0440 \u043A\u0440\u0443\u0436\u043A\u0430 = ", sizeUnit] })] })] }) })] })] }), (0, jsx_runtime_1.jsxs)(styles_1.ChartArea, { ref: chartAreaRef, className: [selectMode ? 'mode-select' : '', panActive ? 'panning' : ''].join(' ').trim(), onMouseDown: handleMouseDown, onMouseMove: handleMouseMove, onMouseUp: handleMouseUp, onMouseLeave: handleMouseLeave, children: [stores.length === 0 && ((0, jsx_runtime_1.jsxs)(EmptyOverlay, { role: "status", "aria-live": "polite", children: [(0, jsx_runtime_1.jsx)(EmptyTitle, { children: "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445" }), (0, jsx_runtime_1.jsx)(EmptyHint, { children: "\u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u043C\u0435\u0442\u0440\u0438\u043A\u0438 X/Y \u0438 \u0438\u0437\u043C\u0435\u0440\u0435\u043D\u0438\u0435 \u043C\u0430\u0433\u0430\u0437\u0438\u043D\u0430 \u0432 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0430\u0445" })] })), (0, jsx_runtime_1.jsx)(styles_1.ChartSvg, { ref: svgRef, onClick: handleSvgClick, onDoubleClick: handleSvgDoubleClick, onMouseMove: handleSvgMouseMove, onMouseLeave: handleSvgMouseLeave, onKeyDown: handleSvgKeyDown }), (0, jsx_runtime_1.jsxs)(styles_1.SelectionOverlay, { children: [selectMode === 'rect' && selectionStart && selectionPath.length > 0 && ((0, jsx_runtime_1.jsx)("div", { className: "selection-rect", style: {
                                ...
                                Object.keys(quadrants).map((key) => {
                                    ...
                                    const inQuad = visibleStores
                                        .filter((s) => (0, quadrants_1.getQuadrant)(s, thresholds) === key)
                                        .map((s) => s.id);
                                    ...
                                    return ((0, jsx_runtime_1.jsxs)(styles_1.QuadAnnot, { side: pos.side, style: style, className: allSelected ? 'on' : '', type: "button", "aria-pressed": allSelected, "aria-label": `${q.label}: ${stat.count} объектов, ${allSelected ? 'снять выделение' : 'выделить'}`, title: allSelected ? 'Снять выделение квадранта' : 'Выделить все объекты квадранта', onClick: () => {
                                            ...
                                            commitFilters(next);
                                        }, children: [(0, jsx_runtime_1.jsx)("div", { className: "qa-label", style: { color: q.color }, children: q.label }), (0, jsx_runtime_1.jsxs)("div", { className: "qa-count", children: [formatCount(stat.count), (0, jsx_runtime_1.jsx)("span", { className: "u", children: "\u043E\u0431\u044A\u0435\u043A\u0442\u043E\u0432" })] }), stat.loss > 0 && ((0, jsx_runtime_1.jsxs)("div", { className: "qa-loss", children: [formatLoss(stat.loss), " \u043F\u043E\u0442\u0435\u0440\u044C"] }))] }, key));
                                })] }), (0, jsx_runtime_1.jsx)(styles_1.Legend, { children: (0, jsx_runtime_1.jsx)(Legend_1.default, { formats: formats, hiddenFormats: hiddenFormats, onToggle: (id, solo) => {
                                if (solo) {
                            ...
                            } }) })] }), (0, react_dom_1.createPortal)((0, jsx_runtime_1.jsxs)(styles_1.PortalRoot, { "data-theme": themeMode, children: [(0, jsx_runtime_1.jsx)(styles_1.Tooltip, { ref: tooltipRef, role: "tooltip", "aria-hidden": "true" }), overlapState && ((0, jsx_runtime_1.jsxs)(styles_1.OverlapList, { ref: overlapRef, "data-visible": "true", "data-locked": overlapState.locked ? 'true' : 'false', role: "listbox", "aria-label": `${overlapState.stores.length} магазинов в этой точке`, style: {
                            ...
                            if (!overlapState.locked)
                                closeOverlap();
                        }, children: [(0, jsx_runtime_1.jsxs)("div", { className: "ol-head", children: [overlapState.stores.length, " \u043C\u0430\u0433\u0430\u0437\u0438\u043D\u043E\u0432 \u0440\u044F\u0434\u043E\u043C"] }), overlapState.stores.map((s) => {
                                const color = formatColorMap.get(s.format) || 'var(--g500)';
                                return ((0, jsx_runtime_1.jsxs)("button", { type: "button", className: "ol-row", role: "option", "aria-selected": activeFilters.has(s.id), onClick: (e) => {
                                        if (e.ctrlKey || e.metaKey) {
                                            if (drillEnabled)
                                        ...
                                        hideTooltip();
                                    }, children: [(0, jsx_runtime_1.jsx)("span", { className: "ol-dot", style: { background: color } }), (0, jsx_runtime_1.jsx)("span", { className: "ol-name", children: s.name })] }, s.id));
                            }), (0, jsx_runtime_1.jsx)("div", { className: "ol-foot", children: overlapState.locked
                                    ? 'Esc — закрыть'
                                    : 'Ctrl — зафиксировать' })] })), drillEnabled && drillStoreId && ((0, jsx_runtime_1.jsx)(StoreDrillModal_1.default, { storeId: drillStoreId, stores: stores, quadrants: quadrants, thresholds: thresholds, formatColorMap: formatColorMap, formatX: formatX, formatY: formatY, formatSize: formatSize, formatLoss: formatLoss, xShort: xShort, yShort: yShort, sizeUnit: sizeUnit, detailQueryParams: detailQueryParams, onClose: () => setDrillStoreId(null) })), drillEnabled && drillQuadrant && ((0, jsx_runtime_1.jsx)(QuadrantDrillModal_1.default, { quadrantKey: drillQuadrant, quadrants: quadrants, thresholds: thresholds, stores: visibleStores, allStoresTotal: stores.length, formatColorMap: formatColorMap, formatX: formatX, formatY: formatY, formatLoss: formatLoss, formatCount: formatCount, xShort: xShort, yShort: yShort, onClose: () => setDrillQuadrant(null), onOpenStore: (id) => setDrillStoreId(id) })), drillEnabled && drillSelection && ((0, jsx_runtime_1.jsx)(QuadrantDrillModal_1.default, { quadrantKey: null, quadrants: quadrants, thresholds: thresholds, stores: stores, allStoresTotal: stores.length, formatColorMap: formatColorMap, formatX: formatX, formatY: formatY, formatLoss: formatLoss, formatCount: formatCount, xShort: xShort, yShort: yShort, selectionIds: activeFilters.size > 0
