...
function ParetoCardInner(props) {
    ...
    if (dataState === 'loading') {
        return ((0, jsx_runtime_1.jsxs)(styled_1.ParetoCardRoot, { ref: rootRef, width: width, height: height, "data-theme": isDarkMode ? 'dark' : 'light', className: styled_1.PARETO_CARD_CLASS, children: [(0, jsx_runtime_1.jsx)(react_2.Global, { styles: (0, react_2.css) `${keyframes_1.PARETO_KEYFRAMES_CSS}` }), (0, jsx_runtime_1.jsxs)(styled_1.Card, { role: "region", "aria-labelledby": titleId, "aria-busy": "true", "data-no-anim": "", children: [(0, jsx_runtime_1.jsx)(styled_1.CardHead, { children: (0, jsx_runtime_1.jsxs)(styled_1.CardTitleGroup, { children: [(0, jsx_runtime_1.jsxs)(styled_1.CardTitle, { id: titleId, children: [headerText, mockModeEnabled && (0, jsx_runtime_1.jsx)(styled_1.MockBadge, { children: "\u0422\u0415\u0421\u0422" })] }), subtitleText && (0, jsx_runtime_1.jsx)(styled_1.CardSubtitle, { children: subtitleText })] }) }), (0, jsx_runtime_1.jsxs)(styled_1.StateCenter, { role: "status", "aria-label": "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430", children: [(0, jsx_runtime_1.jsx)(styled_1.SkeletonBlock, { w: "60%", h: "18px" }), (0, jsx_runtime_1.jsx)(styled_1.SkeletonBlock, { w: "100%", h: "220px" })] })] })] }));
    }
    return ((0, jsx_runtime_1.jsxs)(styled_1.ParetoCardRoot, { ref: rootRef, width: width, height: height, "data-theme": isDarkMode ? 'dark' : 'light', className: styled_1.PARETO_CARD_CLASS, children: [(0, jsx_runtime_1.jsx)(react_2.Global, { styles: (0, react_2.css) `${keyframes_1.PARETO_KEYFRAMES_CSS}` }), (0, jsx_runtime_1.jsxs)(styled_1.Card, { role: "region", "aria-labelledby": titleId, "data-info-hint-container": "", children: [dataState === 'stale' && (0, jsx_runtime_1.jsx)(styled_1.StaleBar, { "aria-hidden": "true" }), (0, jsx_runtime_1.jsxs)(styled_1.CardHead, { children: [(0, jsx_runtime_1.jsxs)(styled_1.CardTitleGroup, { children: [(0, jsx_runtime_1.jsxs)(styled_1.CardTitle, { id: titleId, children: [headerText, mockModeEnabled && (0, jsx_runtime_1.jsx)(styled_1.MockBadge, { children: "\u0422\u0415\u0421\u0422" }), dataState === 'partial' && ((0, jsx_runtime_1.jsx)(styled_1.PartialBadge, { title: "\u0427\u0430\u0441\u0442\u044C \u0434\u0430\u043D\u043D\u044B\u0445 \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0430", children: "\u0427\u0430\u0441\u0442\u0438\u0447\u043D\u043E" }))] }), subtitleText && (0, jsx_runtime_1.jsx)(styled_1.CardSubtitle, { children: subtitleText }), (0, jsx_runtime_1.jsx)(Breadcrumb_1.default, { state: state, items: computed.items, onReset: () => dispatch({ type: 'resetFilters' }) })] }), (0, jsx_runtime_1.jsxs)(styled_1.ControlsRow, { children: [(0, jsx_runtime_1.jsx)(RuntimeControls_1.default, { state: state, hasPrevData: hasPrevData, onUnitChange: unit => dispatch({ type: 'setUnit', value: unit }), onThresholdChange: v => dispatch({ type: 'setThreshold', value: v }), onToggleTopA: () => dispatch({ type: 'toggleTopA' }), onTogglePrev: () => dispatch({ type: 'togglePrev' }) }), (0, jsx_runtime_1.jsx)(HintRow_1.default, {})] })] }), (0, jsx_runtime_1.jsx)(VitalFewSummary_1.default, { vitalFew: computed.vitalFew, metricGenitive: metricGenitive, metricUnit: metricUnit }), (0, jsx_runtime_1.jsx)(styled_1.ChartBox, { role: "img", "aria-label": chartAriaLabel, children: dataState === 'empty' || dataState === 'error' ? ((0, jsx_runtime_1.jsx)(EmptyState_1.default, { state: dataState })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(ChartCanvas_1.default, { option: option, width: width, height: height, items: computed.items, onHoverItem: setHover, onItemClick: onItemClick, onBackgroundClick: onBackgroundClick }), hover && ((0, jsx_runtime_1.jsx)(ChartTooltip_1.default, { item: hover.item, x: hover.x, y: hover.y, tokens: tokens, metricLabel: metricLabel, metricUnit: metricUnit, showPrev: state.prevOverlay }))] })) }), (0, jsx_runtime_1.jsx)(styled_1.CardFooter, { children: (0, jsx_runtime_1.jsx)(ZoneLegend_1.default, { state: state, tokens: tokens, metricLabel: metricLabel, onToggleZone: zone => dispatch({ type: 'toggleZone', zone }), onToggleSeries: kind => dispatch({
                                type: 'setSeries',
                                kind,
                                visible: !state.seriesVisible[kind],
                            }) }) })] }), drillItem && ((0, jsx_runtime_1.jsx)(DrillModal_1.default, { item: drillItem, computed: computed, tokens: tokens, metricLabel: metricLabel, metricUnit: metricUnit, breakdownTitle: breakdownTitle, isDarkMode: isDarkMode, onClose: () => dispatch({ type: 'closeDrill' }) }))] }));
}
