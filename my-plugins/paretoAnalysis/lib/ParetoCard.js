...
function ParetoCardInner(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(styled_1.ParetoCardRoot, { ref: rootRef, width: width, height: height, "data-theme": isDarkMode ? 'dark' : 'light', className: styled_1.PARETO_CARD_CLASS, children: [(0, jsx_runtime_1.jsx)(react_2.Global, { styles: (0, react_2.css) `${keyframes_1.PARETO_KEYFRAMES_CSS}` }), (0, jsx_runtime_1.jsxs)(styled_1.Card, { role: "region", "aria-labelledby": titleId, children: [(0, jsx_runtime_1.jsxs)(styled_1.CardHead, { children: [(0, jsx_runtime_1.jsxs)(styled_1.CardTitleGroup, { children: [(0, jsx_runtime_1.jsx)(styled_1.CardTitle, { id: titleId, children: headerText }), (0, jsx_runtime_1.jsx)(Breadcrumb_1.default, { state: state, items: computed.items, onReset: () => dispatch({ type: 'resetFilters' }) })] }), (0, jsx_runtime_1.jsx)(styled_1.ControlsRow, { children: (0, jsx_runtime_1.jsx)(RuntimeControls_1.default, { state: state, hasPrevData: hasPrevData, onUnitChange: unit => dispatch({ type: 'setUnit', value: unit }), onThresholdChange: v => dispatch({ type: 'setThreshold', value: v }), onToggleTopA: () => dispatch({ type: 'toggleTopA' }), onTogglePrev: () => dispatch({ type: 'togglePrev' }) }) })] }), (0, jsx_runtime_1.jsx)(VitalFewSummary_1.default, { vitalFew: computed.vitalFew, metricGenitive: metricGenitive, metricUnit: metricUnit }), (0, jsx_runtime_1.jsx)(styled_1.ChartBox, { role: "img", "aria-label": chartAriaLabel, children: dataState !== 'populated' ? ((0, jsx_runtime_1.jsx)(EmptyState_1.default, { state: dataState })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(ChartCanvas_1.default, { option: option, width: width, height: height, onHoverItem: setHover, onItemClick: onItemClick, onBackgroundClick: onBackgroundClick }), hover && ((0, jsx_runtime_1.jsx)(ChartTooltip_1.default, { item: hover.item, x: hover.x, y: hover.y, tokens: tokens, metricLabel: metricLabel, metricUnit: metricUnit, showPrev: state.prevOverlay }))] })) }), (0, jsx_runtime_1.jsxs)(styled_1.CardFooter, { children: [(0, jsx_runtime_1.jsx)(HintRow_1.default, {}), (0, jsx_runtime_1.jsx)(ZoneLegend_1.default, { state: state, tokens: tokens, metricLabel: metricLabel, onToggleZone: zone => dispatch({ type: 'toggleZone', zone }), onToggleSeries: kind => dispatch({
                                    type: 'setSeries',
                                    kind,
                                    visible: !state.seriesVisible[kind],
                                }) }), (0, jsx_runtime_1.jsx)("div", {})] })] }), drillItem && ((0, jsx_runtime_1.jsx)(DrillModal_1.default, { item: drillItem, computed: computed, tokens: tokens, metricLabel: metricLabel, metricUnit: metricUnit, breakdownTitle: breakdownTitle, isDarkMode: isDarkMode, onClose: () => dispatch({ type: 'closeDrill' }) }))] }));
}
