...
exports.initParetoState = initParetoState;
exports.useParetoState = useParetoState;
...
function initParetoState(defaultThreshold) {
    return {
...
function useParetoState(defaultThreshold) {
    return (0, react_1.useReducer)(reducer, defaultThreshold, initParetoState);
}
