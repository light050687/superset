...
export default function DrillModal({ item, computed, tokens, metricLabel, metricUnit, breakdownTitle, isDarkMode, onClose, }) {
    ...
    const rankDeltaClass = item.rankDelta == null || item.rankDelta === 0
        ...
        : item.rankDelta > 0
            ? 'bad'
            : 'good';
    const content = (_jsxs(ModalOverlay, { "data-theme": isDarkMode ? 'dark' : 'light', role: "dialog", "aria-modal": "true", "aria-label": `Разложение: ${item.name}`, children: [_jsx("div", { className: "backdrop", onClick: onClose }), _jsxs(ModalCard, { children: [_jsxs(ModalHead, { children: [_jsxs(ModalTitle, { children: [_jsxs("div", { className: "m-eyebrow", children: ["\u0420\u0430\u0437\u043B\u043E\u0436\u0435\u043D\u0438\u0435 \u00B7 ", zoneLabel(item.zone), item.isNewInA ? ' · ★ впервые в A' : ''] }), _jsxs("div", { className: "m-h", children: [_jsx("span", { className: "dot", style: { background: zCol } }), _jsx("span", { children: item.name })] })] }), _jsx(ModalClose, { "aria-label": "\u0417\u0430\u043A\u0440\u044B\u0442\u044C", onClick: onClose, type: "button", children: _jsx("svg", { viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", "aria-hidden": true, children: _jsx("path", { d: "M3 3 L13 13 M13 3 L3 13" }) }) })] }), _jsxs(ModalBody, { children: [_jsxs(DrillSummaryGrid, { children: [_jsxs("div", { children: [_jsx("div", { className: "s-l", children: "\u0420\u0430\u043D\u0433" }), _jsxs("div", { className: `s-v ${zClass}`, children: ["#", item.rank] })] }), _jsxs("div", { children: [_jsx("div", { className: "s-l", children: metricLabel }), _jsx("div", { className: `s-v ${zClass}`, children: formatMetricValue(item.value, metricUnit) })] }), _jsxs("div", { children: [_jsx("div", { className: "s-l", children: "\u0414\u043E\u043B\u044F" }), _jsx("div", { className: "s-v", children: formatPct2(item.share) })] }), _jsxs("div", { children: [_jsx("div", { className: "s-l", children: "\u041A\u0443\u043C\u0443\u043B\u044F\u0442\u0438\u0432\u043D\u043E" }), _jsx("div", { className: "s-v", children: formatPct1(item.cumPct) })] })] }), _jsxs(DrillContext, { children: [_jsxs("div", { className: "ctx-row", children: [_jsxs("div", { className: "ctx-l", children: [_jsx("span", { className: "ctx-label", children: "\u041F\u043E\u0442\u0435\u0440\u0438 \u043E\u0442 \u0432\u044B\u0440\u0443\u0447\u043A\u0438 \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0438" }), _jsxs("span", { className: "ctx-hint", children: [formatMetricValue(item.value, metricUnit), " \u0438\u0437", ' ', formatMetricValue(item.revenueRub ?? null, metricUnit)] })] }), _jsxs("div", { className: "ctx-bar-wrap", children: [_jsx("div", { className: "ctx-bar", children: _jsx("div", { className: `ctx-bar-fill ${lossStatus}`, style: { width: `${lossBarW}%` } }) }), _jsx("div", { className: "ctx-bar-avg", style: {
                                                            left: `${Math.round((avgLossPct / maxLossPct) * 100)}%`,
                                                        }, title: `Среднее по категориям: ${formatPct2(avgLossPct)}` })] }), _jsx("div", { className: `ctx-v ${lossStatus}`, children: formatPct2(lossPct) })] }), _jsxs("div", { className: "ctx-row", children: [_jsxs("div", { className: "ctx-l", children: [_jsx("span", { className: "ctx-label", children: "\u0418\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u0435 \u043A \u043F\u0440\u043E\u0448\u043B\u043E\u043C\u0443 \u043F\u0435\u0440\u0438\u043E\u0434\u0443" }), _jsxs("span", { className: "ctx-hint", children: ["\u0431\u044B\u043B\u043E ", formatMetricValue(prev ?? null, metricUnit), " \u2192 \u0441\u0442\u0430\u043B\u043E", ' ', formatMetricValue(item.value, metricUnit)] })] }), _jsx("div", { className: "ctx-bar-wrap" }), _jsx("div", { className: `ctx-v ${deltaClass}`, children: formatSignedPct1(deltaPct) })] }), _jsxs("div", { className: "ctx-row", children: [_jsxs("div", { className: "ctx-l", children: [_jsx("span", { className: "ctx-label", children: "\u0414\u0432\u0438\u0436\u0435\u043D\u0438\u0435 \u043F\u043E \u0440\u0430\u043D\u0433\u0443" }), _jsx("span", { className: "ctx-hint", children: "\u043F\u043E\u0437\u0438\u0446\u0438\u044F \u0432 \u041F\u0430\u0440\u0435\u0442\u043E" })] }), _jsx("div", { className: "ctx-bar-wrap" }), _jsx("div", { className: `ctx-v ${rankDeltaClass}`, children: rankDeltaTxt })] })] }), _jsx(DrillSectionTitle, { children: breakdownTitle }), _jsx(DrillBars, { children: breakdown.map((b, idx) => {
                                    const w = Math.round((b.rub / maxRub) * 100);
                                    const pctOfTotal = item.value > 0 ? (b.rub / item.value) * 100 : 0;
                                    return (_jsxs("div", { className: "dbf", children: [_jsx("div", { className: "dbf-l", children: b.name }), _jsx("div", { className: "dbf-bar", children: _jsx("div", { className: "dbf-bar-fill", style: {
                                                        width: `${w}%`,
