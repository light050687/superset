...
export function getBreakdown(id, totalRub) {
 ...
 */
export function getParetoPreset(preset, customJson) {
    if (preset === 'custom' && customJson) {
        try {
            ...
            return {
                ...
                breakdownTitle: parsed.breakdownTitle ?? LOSSES_PRESET.breakdownTitle,
            };
        }
        catch {
            return EMPTY_PRESET;
