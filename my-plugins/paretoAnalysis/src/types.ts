...
// ═══════════════════════════════════════
// Form data (controlPanel snake_case → camelCase in chartProps.formData)
// ═══════════════════════════════════════
...
// ═══════════════════════════════════════
// Runtime state (inside the chart — useReducer)
// ═══════════════════════════════════════
...
export interface ParetoState {
  ...
  seriesVisible: { bars: boolean; line: boolean };
  drillId: string | null;
}

// ═══════════════════════════════════════
// Component props (output of transformProps)
// ═══════════════════════════════════════
...
// ═══════════════════════════════════════
// Theme tokens (hex values for ECharts canvas)
// ═══════════════════════════════════════
