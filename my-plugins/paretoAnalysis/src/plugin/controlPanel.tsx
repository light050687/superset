        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Показывает тестовые данные из прототипа (14 товарных категорий). ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Формат: {"items":[{"id":"1","name":"X","value":10,"revenueRub":100,"valuePrev":8}], ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Опционально: включает ghost-бары «Пред. период» и движение рангов (▲/▼).',
              ),
              validators: [],
            },
          },
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Если пусто — берётся активный диапазон времени (Last year → «за год»).',
              ),
              default: '',
              renderTrigger: true,
            },
