...
import { DrillBars, DrillHelperText, DrillSectionTitle, DrillSummary, Modal, ModalBackdrop, ModalBody, ModalClose, ModalHead, ModalRoot, ModalTitle, } from './styles';
    ...
    return (_jsxs(ModalRoot, { className: "show", role: "dialog", "aria-modal": "true", "aria-label": `${eyebrow}: ${summary.title}`, onClick: (e) => {
            if (e.target === e.currentTarget)
                onClose();
                                                    ...
                                                    : '—' })] }), _jsxs("div", { children: [_jsx("div", { className: "s-l", children: "\u0421\u0442\u0430\u0442\u0443\u0441" }), _jsx("div", { className: `s-v ${statusClass}`, children: STATUS_LABEL[status] })] })] }), summary.shops != null && (_jsxs(DrillSectionTitle, { children: ["\u041C\u0430\u0433\u0430\u0437\u0438\u043D\u043E\u0432: ", formatRussianInt(summary.shops)] })), _jsx(DrillSectionTitle, { children: "\u0420\u0430\u0437\u043B\u043E\u0436\u0435\u043D\u0438\u0435 \u043F\u043E \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044F\u043C" }), loading && _jsx(DrillHelperText, { children: "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430\u2026" }), !loading && breakdown.length === 0 && (_jsx(DrillHelperText, { children: drillQueryParams?.breakdownCol
