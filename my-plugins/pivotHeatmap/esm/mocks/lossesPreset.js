...
export const MOCK_COLS_DIVISION = [
...
export const MOCK_COLS_UPR_REGION = [
...
export function buildMockCells(axisKey = 'division') {
    const cells = new Map();
