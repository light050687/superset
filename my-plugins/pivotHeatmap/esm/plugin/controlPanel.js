                ...
                [
                    {
                        ...
                        config: {
                            ...
                            description: t('Показывает синтетические данные из прототипа (5 форматов × 7 дивизионов, потери с breakdown). Выключите, когда реальные данные будут готовы.'),
                            default: false,
                            renderTrigger: true,
                        },
                    },
                ...
                [
                    {
                        ...
                        config: {
                            ...
                            description: t('Длинные названия обрезаются до N символов и завершаются «…». Полное имя видно по hover. 0 или отрицательное — без ограничения.'),
                            default: 18,
                            isInt: true,
                            renderTrigger: true,
                        },
                    },
                    {
                        ...
                        config: {
                            ...
                            description: t('Аналогично для шапок строк (форматов магазинов и т.п.). 0 — без ограничения.'),
                            default: 24,
                            isInt: true,
                            renderTrigger: true,
                        },
