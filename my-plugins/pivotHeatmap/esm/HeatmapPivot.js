...
import { Breadcrumbs, BreadcrumbBack, BreadcrumbCurrent, BreadcrumbSel, Card, Cell, Chip, ColProfile, Controls, Footer, Header, HintBar, KEYFRAMES_CSS, Pivot, PivotWrap, ROOT_CLASS, Root, Scale, ScaleItem, SkeletonGrid, StateOverlay, Title, TitleBlock, Tooltip, Unit, UnitButton, } from './styles';
...
export default function HeatmapPivot(props) {
    ...
    return (_jsxs(Root, { "data-theme": theme, className: ROOT_CLASS, width: width, height: height, children: [_jsx("style", { children: KEYFRAMES_CSS }), _jsxs(Card, { children: [_jsxs(Header, { children: [_jsxs(TitleBlock, { children: [_jsx(Title, { children: headerText }), _jsxs(Breadcrumbs, { role: "navigation", "aria-label": "\u041A\u043E\u043D\u0442\u0435\u043A\u0441\u0442 \u0444\u0438\u043B\u044C\u0442\u0440\u043E\u0432", children: [_jsx(BreadcrumbCurrent, { children: headerSubtitle }), breadcrumbChips.length > 0 && (_jsxs(_Fragment, { children: [_jsx("span", { style: { color: 'var(--g300)' }, children: "\u00B7" }), _jsx(BreadcrumbCurrent, { children: "\u0424\u0438\u043B\u044C\u0442\u0440:" }), breadcrumbChips.map((chip, i) => (_jsxs("span", { children: [_jsx(BreadcrumbSel, { children: chip }), i < breadcrumbChips.length - 1 && (_jsx("span", { style: { color: 'var(--g300)', margin: '0 4px' }, children: "+" }))] }, chip))), _jsx(BreadcrumbBack, { type: "button", onClick: clearAllFilters, "aria-label": "\u0421\u043D\u044F\u0442\u044C \u0432\u0441\u0435 \u0444\u0438\u043B\u044C\u0442\u0440\u044B", title: "\u0421\u043D\u044F\u0442\u044C (Esc)", children: "\u00D7" })] }))] })] }), _jsxs(Controls, { children: [_jsxs(Unit, { role: "tablist", "aria-label": "\u0415\u0434\u0438\u043D\u0438\u0446\u044B \u0438\u0437\u043C\u0435\u0440\u0435\u043D\u0438\u044F", children: [_jsx(UnitButton, { type: "button", on: unit === 'abs', onClick: () => setUnit('abs'), "aria-pressed": unit === 'abs', title: "\u0410\u0431\u0441\u043E\u043B\u044E\u0442\u043D\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435", children: unitSuffix.includes('₽') ? '₽' : 'Σ' }), _jsx(UnitButton, { type: "button", on: unit === 'pct', onClick: () => setUnit('pct'), "aria-pressed": unit === 'pct', title: "\u041F\u0440\u043E\u0446\u0435\u043D\u0442", children: "%" })] }), _jsxs(Chip, { type: "button", on: showTotals, onClick: () => setShowTotals((v) => !v), "aria-pressed": showTotals, title: "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0441\u0442\u0440\u043E\u043A\u0443 \u0438 \u043A\u043E\u043B\u043E\u043D\u043A\u0443 \u0438\u0442\u043E\u0433\u043E\u0432", children: [_jsx("span", { className: "sigma", children: "\u03A3" }), _jsx("span", { children: "\u0418\u0442\u043E\u0433\u0438" })] })] })] }), _jsx(PivotWrap, { children: _jsxs(Pivot, { role: "grid", "aria-label": headerText, children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { className: "corner", scope: "col", "aria-label": "\u0424\u043E\u0440\u043C\u0430\u0442" }), cols.map((col) => {
                                            ...
                                            return (_jsxs("tr", { className: rowHl ? 'row-hl' : '', children: [_jsx("th", { scope: "row", className: row.id === rowFilter ? 'filtered' : '', onClick: (e) => onRowHeaderClick(e, row), onMouseEnter: (e) => onRowHeaderEnter(e, row), onMouseLeave: onHeaderLeave, onMouseMove: onHeaderMove, tabIndex: 0, title: "\u041A\u043B\u0438\u043A \u2014 \u0444\u0438\u043B\u044C\u0442\u0440 \u00B7 \u21E7 \u2014 \u0441\u0440\u0430\u0432\u043D\u0438\u0442\u044C", children: row.name }), cols.map((col) => {
                                                ...
                                                })()] }))] })] }) }), _jsxs(Footer, { children: [_jsxs(Scale, { "aria-label": "\u0428\u043A\u0430\u043B\u0430 \u043F\u043E\u0440\u043E\u0433\u043E\u0432", children: [_jsxs(ScaleItem, { className: "ok", children: [_jsx("span", { className: "sw", "aria-hidden": "true" }), _jsxs("span", { className: "label", children: [STATUS_LABEL.ok, " \u00B7 ratio \u2264 ", thresholds.ok] })] }), _jsxs(ScaleItem, { className: "wn", children: [_jsx("span", { className: "sw", "aria-hidden": "true" }), _jsxs("span", { className: "label", children: [STATUS_LABEL.wn, " \u00B7 \u0434\u043E ", thresholds.wn] })] }), _jsxs(ScaleItem, { className: "dn", children: [_jsx("span", { className: "sw", "aria-hidden": "true" }), _jsxs("span", { className: "label", children: [STATUS_LABEL.dn, " \u00B7 \u0432\u044B\u0448\u0435 ", thresholds.wn] })] }), _jsxs(ScaleItem, { className: "nd", children: [_jsx("span", { className: "sw", "aria-hidden": "true" }), _jsx("span", { className: "label", children: STATUS_LABEL.nd })] })] }), _jsxs(HintBar, { children: [_jsx("span", { className: "hi", children: "\u043A\u043B\u0438\u043A \u2014 \u0444\u0438\u043B\u044C\u0442\u0440" }), _jsx("span", { className: "hi", children: "Ctrl+\u043A\u043B\u0438\u043A \u2014 \u0440\u0430\u0437\u043B\u043E\u0436\u0435\u043D\u0438\u0435" }), _jsx("span", { className: "hi", children: "\u21E7 \u043A\u043B\u0438\u043A \u2014 \u0441\u0440\u0430\u0432\u043D\u0438\u0442\u044C" })] })] })] }), _jsxs(Tooltip, { className: tooltip.show ? 'show' : '', style: { left: tooltip.x, top: tooltip.y }, role: "tooltip", "aria-hidden": !tooltip.show, children: [_jsxs("div", { className: "tt-title", children: [_jsx("span", { className: "dot", style: {
