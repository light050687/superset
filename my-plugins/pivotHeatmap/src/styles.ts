...
export const AxisDropdownRoot = styled.div`
  position: relative;
...
export const AxisDropdownGhost = styled.span`
  visibility: hidden;
  pointer-events: none;
  display: block;
  font-family: var(--m);
...
export const AxisDropdownPanel = styled.div<{ open?: boolean }>`
  box-sizing: border-box;
  position: absolute;
  top: 0;
  left: 0;
...
export const AxisDropdownTrigger = styled.button`
...
export const AxisDropdownMenu = styled.div`
  display: flex;
  flex-direction: column;
  width: 100%;
...
export const AxisDropdownItem = styled.button<{ active?: boolean }>`
...
export const PivotWrap = styled.div`
  position: relative;
  overflow: auto;
  flex: 1;
  min-height: 0;
...
export const Pivot = styled.table`
...
export const CmpTable = styled.table`
  width: 100%;
  border-collapse: separate;
  border-spacing: 0;
  font-variant-numeric: tabular-nums;
