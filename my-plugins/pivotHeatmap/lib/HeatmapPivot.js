...
function HeatmapPivot(props) {
    ...
    // ── Render ──
    return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { "data-theme": theme, className: styles_1.ROOT_CLASS, width: width, height: height, children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsxs)(styles_1.Card, { children: [(0, jsx_runtime_1.jsxs)(styles_1.Header, { children: [(0, jsx_runtime_1.jsxs)(styles_1.TitleBlock, { children: [(0, jsx_runtime_1.jsx)(styles_1.Title, { children: headerText }), (0, jsx_runtime_1.jsxs)(styles_1.Breadcrumbs, { role: "navigation", "aria-label": "\u041A\u043E\u043D\u0442\u0435\u043A\u0441\u0442 \u0444\u0438\u043B\u044C\u0442\u0440\u043E\u0432", children: [(0, jsx_runtime_1.jsx)(styles_1.BreadcrumbCurrent, { children: headerSubtitle }), breadcrumbChips.length > 0 && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { style: { color: 'var(--g300)' }, children: "\u00B7" }), (0, jsx_runtime_1.jsx)(styles_1.BreadcrumbCurrent, { children: "\u0424\u0438\u043B\u044C\u0442\u0440:" }), breadcrumbChips.map((chip, i) => ((0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)(styles_1.BreadcrumbSel, { children: chip }), i < breadcrumbChips.length - 1 && ((0, jsx_runtime_1.jsx)("span", { style: { color: 'var(--g300)', margin: '0 4px' }, children: "+" }))] }, chip))), (0, jsx_runtime_1.jsx)(styles_1.BreadcrumbBack, { type: "button", onClick: clearAllFilters, "aria-label": "\u0421\u043D\u044F\u0442\u044C \u0432\u0441\u0435 \u0444\u0438\u043B\u044C\u0442\u0440\u044B", title: "\u0421\u043D\u044F\u0442\u044C (Esc)", children: "\u00D7" })] }))] })] }), (0, jsx_runtime_1.jsxs)(styles_1.Controls, { children: [(0, jsx_runtime_1.jsxs)(styles_1.Unit, { role: "tablist", "aria-label": "\u0415\u0434\u0438\u043D\u0438\u0446\u044B \u0438\u0437\u043C\u0435\u0440\u0435\u043D\u0438\u044F", children: [(0, jsx_runtime_1.jsx)(styles_1.UnitButton, { type: "button", on: unit === 'abs', onClick: () => setUnit('abs'), "aria-pressed": unit === 'abs', title: "\u0410\u0431\u0441\u043E\u043B\u044E\u0442\u043D\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435", children: unitSuffix.includes('₽') ? '₽' : 'Σ' }), (0, jsx_runtime_1.jsx)(styles_1.UnitButton, { type: "button", on: unit === 'pct', onClick: () => setUnit('pct'), "aria-pressed": unit === 'pct', title: "\u041F\u0440\u043E\u0446\u0435\u043D\u0442", children: "%" })] }), (0, jsx_runtime_1.jsxs)(styles_1.Chip, { type: "button", on: showTotals, onClick: () => setShowTotals((v) => !v), "aria-pressed": showTotals, title: "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0441\u0442\u0440\u043E\u043A\u0443 \u0438 \u043A\u043E\u043B\u043E\u043D\u043A\u0443 \u0438\u0442\u043E\u0433\u043E\u0432", children: [(0, jsx_runtime_1.jsx)("span", { className: "sigma", children: "\u03A3" }), (0, jsx_runtime_1.jsx)("span", { children: "\u0418\u0442\u043E\u0433\u0438" })] })] })] }), (0, jsx_runtime_1.jsx)(styles_1.PivotWrap, { children: (0, jsx_runtime_1.jsxs)(styles_1.Pivot, { role: "grid", "aria-label": headerText, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { className: "corner", scope: "col", "aria-label": "\u0424\u043E\u0440\u043C\u0430\u0442" }), cols.map((col) => {
