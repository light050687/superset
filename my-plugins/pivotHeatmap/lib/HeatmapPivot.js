...
function HeatmapPivot(props) {
    ...
    const [axisKey, setAxisKey] = (0, react_1.useState)(() => colAxisOptions?.[0]?.key ?? 'division');
    ...
    const activeAxis = (0, react_1.useMemo)(() => colAxisOptions?.find((o) => o.key === axisKey) ?? null, [colAxisOptions, axisKey]);
    ...
    // Dropdown open state
    const [axisOpen, setAxisOpen] = (0, react_1.useState)(false);
    const axisRootRef = (0, react_1.useRef)(null);
    (0, react_1.useEffect)(() => {
        if (!axisOpen)
            return undefined;
        const onDown = (e) => {
    ...
    if (dataState === 'loading') {
        ...
        return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { "data-theme": theme, className: styles_1.ROOT_CLASS, width: width, height: height, "aria-busy": "true", "aria-live": "polite", children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsxs)(styles_1.Card, { "data-no-anim": "", children: [(0, jsx_runtime_1.jsx)(styles_1.Header, { children: (0, jsx_runtime_1.jsx)(styles_1.TitleBlock, { children: (0, jsx_runtime_1.jsxs)(styles_1.Title, { children: [headerText, mockMode && (0, jsx_runtime_1.jsx)(styles_1.MockBadge, { children: "\u0422\u0415\u0421\u0422" })] }) }) }), (0, jsx_runtime_1.jsxs)(styles_1.SkeletonGrid, { children: [(0, jsx_runtime_1.jsx)("div", { className: "sk hdr" }), (0, jsx_runtime_1.jsx)("div", { className: "sk hdr" }), (0, jsx_runtime_1.jsx)("div", { className: "sk hdr" }), (0, jsx_runtime_1.jsx)("div", { className: "sk hdr" }), (0, jsx_runtime_1.jsx)("div", { className: "sk hdr" }), (0, jsx_runtime_1.jsx)("div", { className: "sk hdr" }), Array.from({ length: 25 }).map((_, i) => (0, jsx_runtime_1.jsx)("div", { className: "sk" }, i))] })] })] }));
    }
    if (dataState === 'error') {
        return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { "data-theme": theme, className: styles_1.ROOT_CLASS, width: width, height: height, children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsx)(styles_1.Card, { "data-no-anim": "", children: (0, jsx_runtime_1.jsx)(styles_1.StateOverlay, { role: "alert", children: errorMessage ?? 'Произошла ошибка при загрузке данных' }) })] }));
    }
    if (dataState === 'empty' && cells.size === 0) {
        return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { "data-theme": theme, className: styles_1.ROOT_CLASS, width: width, height: height, children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsxs)(styles_1.Card, { "data-no-anim": "", children: [(0, jsx_runtime_1.jsx)(styles_1.Header, { children: (0, jsx_runtime_1.jsx)(styles_1.TitleBlock, { children: (0, jsx_runtime_1.jsxs)(styles_1.Title, { children: [headerText, mockMode && (0, jsx_runtime_1.jsx)(styles_1.MockBadge, { children: "\u0422\u0415\u0421\u0422" })] }) }) }), (0, jsx_runtime_1.jsx)(styles_1.StateOverlay, { children: errorMessage ?? 'Нет данных за выбранный период' })] })] }));
    }
    // ── Render ──
    const isPartial = dataState === 'partial';
    const isStale = dataState === 'stale';
    return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { "data-theme": theme, className: styles_1.ROOT_CLASS, width: width, height: height, children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsxs)(styles_1.Card, { style: { position: 'relative' }, "data-info-hint-container": "", children: [isStale && (0, jsx_runtime_1.jsx)(styles_1.StaleBar, { "aria-hidden": "true" }), (0, jsx_runtime_1.jsxs)(styles_1.Header, { children: [(0, jsx_runtime_1.jsxs)(styles_1.TitleBlock, { children: [(0, jsx_runtime_1.jsxs)(styles_1.Title, { children: [headerText, mockMode && (0, jsx_runtime_1.jsx)(styles_1.MockBadge, { children: "\u0422\u0415\u0421\u0422" })] }), isPartial && ((0, jsx_runtime_1.jsx)(styles_1.PartialBadge, { title: "\u0427\u0430\u0441\u0442\u044C \u0434\u0430\u043D\u043D\u044B\u0445 \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0430", children: "\u0427\u0430\u0441\u0442\u0438\u0447\u043D\u043E" })), (0, jsx_runtime_1.jsxs)(styles_1.Breadcrumbs, { role: "navigation", "aria-label": "\u041A\u043E\u043D\u0442\u0435\u043A\u0441\u0442 \u0444\u0438\u043B\u044C\u0442\u0440\u043E\u0432", children: [(0, jsx_runtime_1.jsx)(styles_1.BreadcrumbCurrent, { children: headerSubtitle }), breadcrumbChips.length > 0 && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(styles_1.BreadcrumbDot, { children: "\u00B7" }), (0, jsx_runtime_1.jsx)(styles_1.BreadcrumbCurrent, { children: "\u0424\u0438\u043B\u044C\u0442\u0440:" }), breadcrumbChips.map((chip, i) => ((0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)(styles_1.BreadcrumbSel, { children: chip }), i < breadcrumbChips.length - 1 && ((0, jsx_runtime_1.jsx)(styles_1.BreadcrumbPlus, { children: "+" }))] }, chip))), (0, jsx_runtime_1.jsx)(styles_1.BreadcrumbBack, { type: "button", onClick: clearAllFilters, "aria-label": "\u0421\u043D\u044F\u0442\u044C \u0432\u0441\u0435 \u0444\u0438\u043B\u044C\u0442\u0440\u044B", title: "\u0421\u043D\u044F\u0442\u044C (Esc)", children: "\u00D7" })] }))] })] }), (0, jsx_runtime_1.jsxs)(styles_1.Controls, { children: [colAxisOptions && colAxisOptions.length > 1 && activeAxis && ((0, jsx_runtime_1.jsxs)(styles_1.AxisDropdownRoot, { ref: axisRootRef, children: [(0, jsx_runtime_1.jsx)(styles_1.AxisDropdownGhost, { "aria-hidden": "true", children: colAxisOptions.reduce((longest, o) => (o.label.length > longest.length ? o.label : longest), '') }), (0, jsx_runtime_1.jsxs)(styles_1.AxisDropdownPanel, { open: axisOpen, "data-open": axisOpen, children: [(0, jsx_runtime_1.jsx)(styles_1.AxisDropdownTrigger, { type: "button", "aria-haspopup": "listbox", "aria-expanded": axisOpen, "aria-label": "\u0413\u0440\u0443\u043F\u043F\u0438\u0440\u043E\u0432\u043A\u0430 \u043A\u043E\u043B\u043E\u043D\u043E\u043A", onClick: () => setAxisOpen((v) => !v), children: activeAxis.label }), axisOpen && ((0, jsx_runtime_1.jsx)(styles_1.AxisDropdownMenu, { role: "listbox", "aria-label": "\u0413\u0440\u0443\u043F\u043F\u0438\u0440\u043E\u0432\u043A\u0430 \u043A\u043E\u043B\u043E\u043D\u043E\u043A", children: colAxisOptions.map((opt) => ((0, jsx_runtime_1.jsx)(styles_1.AxisDropdownItem, { type: "button", role: "option", active: opt.key === axisKey, "aria-selected": opt.key === axisKey, onClick: () => {
                                                                setAxisKey(opt.key);
                                                                setAxisOpen(false);
                                                            }, children: opt.label }, opt.key))) }))] })] })), (0, jsx_runtime_1.jsxs)(styles_1.Unit, { role: "tablist", "aria-label": "\u0415\u0434\u0438\u043D\u0438\u0446\u044B \u0438\u0437\u043C\u0435\u0440\u0435\u043D\u0438\u044F", children: [(0, jsx_runtime_1.jsx)(styles_1.UnitButton, { type: "button", on: unit === 'abs', onClick: () => setUnit('abs'), "aria-pressed": unit === 'abs', title: "\u0410\u0431\u0441\u043E\u043B\u044E\u0442\u043D\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435", children: unitSuffix.includes('₽') ? '₽' : 'Σ' }), (0, jsx_runtime_1.jsx)(styles_1.UnitButton, { type: "button", on: unit === 'pct', onClick: () => setUnit('pct'), "aria-pressed": unit === 'pct', title: "\u041F\u0440\u043E\u0446\u0435\u043D\u0442", children: "%" })] }), (0, jsx_runtime_1.jsx)(styles_1.Chip, { type: "button", on: showTotals, onClick: () => setShowTotals((v) => !v), "aria-pressed": showTotals, "aria-label": "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0441\u0442\u0440\u043E\u043A\u0443 \u0438 \u043A\u043E\u043B\u043E\u043D\u043A\u0443 \u0438\u0442\u043E\u0433\u043E\u0432", title: "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0441\u0442\u0440\u043E\u043A\u0443 \u0438 \u043A\u043E\u043B\u043E\u043D\u043A\u0443 \u0438\u0442\u043E\u0433\u043E\u0432", children: (0, jsx_runtime_1.jsx)("span", { className: "sigma", "aria-hidden": "true", children: "\u03A3" }) }), (0, jsx_runtime_1.jsx)(InfoHint_1.InfoHintTopRight, { children: (0, jsx_runtime_1.jsxs)(InfoHint_1.InfoHint, { ariaLabel: "\u041F\u043E\u0434\u0441\u043A\u0430\u0437\u043A\u0430 \u043F\u043E \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044E", children: [(0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [(0, jsx_runtime_1.jsx)("kbd", { children: "\u043A\u043B\u0438\u043A" }), " \u2014 \u0444\u0438\u043B\u044C\u0442\u0440"] }), (0, jsx_runtime_1.jsx)("span", { className: "hi-sep", "aria-hidden": "true" }), (0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [(0, jsx_runtime_1.jsx)("kbd", { children: "Ctrl" }), "+", (0, jsx_runtime_1.jsx)("kbd", { children: "\u043A\u043B\u0438\u043A" }), " \u2014 \u0440\u0430\u0437\u043B\u043E\u0436\u0435\u043D\u0438\u0435"] }), (0, jsx_runtime_1.jsx)("span", { className: "hi-sep", "aria-hidden": "true" }), (0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [(0, jsx_runtime_1.jsx)("kbd", { children: "\u21E7" }), " ", (0, jsx_runtime_1.jsx)("kbd", { children: "\u043A\u043B\u0438\u043A" }), " \u2014 \u0441\u0440\u0430\u0432\u043D\u0438\u0442\u044C"] }), (0, jsx_runtime_1.jsx)("span", { className: "hi-sep", "aria-hidden": "true" }), (0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [(0, jsx_runtime_1.jsx)("kbd", { children: "Right Click" }), " \u2014 \u043C\u0435\u043D\u044E \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0439"] })] }) })] })] }), (0, jsx_runtime_1.jsx)(styles_1.PivotWrap, { children: (0, jsx_runtime_1.jsxs)(styles_1.Pivot, { role: "grid", "aria-label": headerText, children: [(0, jsx_runtime_1.jsx)("thead", { children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { className: "corner", scope: "col", "aria-label": "\u0424\u043E\u0440\u043C\u0430\u0442" }), cols.map((col) => {
                                                ...
                                                return ((0, jsx_runtime_1.jsxs)("th", { scope: "col", className: className, onClick: (e) => onColHeaderClick(e, col), onDoubleClick: (e) => onColHeaderDblClick(e, col), onMouseEnter: (e) => onColHeaderEnter(e, col), onMouseLeave: onHeaderLeave, onMouseMove: onHeaderMove, tabIndex: 0, "aria-label": col.name, children: [shortLabel, arrow && (0, jsx_runtime_1.jsx)("span", { className: "sort-arrow", children: arrow })] }, col.id));
                                            }), showTotals && ((0, jsx_runtime_1.jsx)("th", { className: "totals-col", scope: "col", "aria-label": "\u0418\u0442\u043E\u0433\u043E", children: "\u0418\u0442\u043E\u0433\u043E" }))] }) }), (0, jsx_runtime_1.jsxs)("tbody", { children: [rows.map((row, rowIdx) => {
                                            const rowHl = hoverRow === row.id;
                                            return ((0, jsx_runtime_1.jsxs)("tr", { className: rowHl ? 'row-hl' : '', children: [(() => {
                                                        const shortRowLabel = truncateLabel(row.name, rowLabelMaxChars);
                                                        const rowTruncated = shortRowLabel !== row.name;
                                                        return ((0, jsx_runtime_1.jsx)("th", { scope: "row", className: row.id === rowFilter ? 'filtered' : '', onClick: (e) => onRowHeaderClick(e, row), onMouseEnter: (e) => onRowHeaderEnter(e, row), onMouseLeave: onHeaderLeave, onMouseMove: onHeaderMove, tabIndex: 0, "aria-label": row.name, children: shortRowLabel }));
                                                    })(), cols.map((col, colIdx) => {
                                                        const cell = cells.get(`${row.id}|${col.id}`);
                                                        const st = (0, thresholds_1.cellStatus)(cell, thresholds);
                                                        ...
                                                        return ((0, jsx_runtime_1.jsx)("td", { className: colHl ? 'col-hl' : '', 
                                        ...
                                        }), showTotals && ((0, jsx_runtime_1.jsxs)("tr", { className: "totals-row", children: [(0, jsx_runtime_1.jsx)("th", { scope: "row", children: "\u0418\u0442\u043E\u0433\u043E" }), cols.map((col) => {
                                                ...
                                                })()] }))] })] }) }), (0, jsx_runtime_1.jsx)(styles_1.Footer, { children: (0, jsx_runtime_1.jsxs)(styles_1.Scale, { "aria-label": "\u0428\u043A\u0430\u043B\u0430 \u043F\u043E\u0440\u043E\u0433\u043E\u0432", children: [(0, jsx_runtime_1.jsxs)(styles_1.ScaleItem, { className: "ok", children: [(0, jsx_runtime_1.jsx)("span", { className: "sw", "aria-hidden": "true" }), (0, jsx_runtime_1.jsxs)("span", { className: "label", children: [thresholds_1.STATUS_LABEL.ok, " \u00B7 ratio \u2264 ", thresholds.ok] })] }), (0, jsx_runtime_1.jsxs)(styles_1.ScaleItem, { className: "wn", children: [(0, jsx_runtime_1.jsx)("span", { className: "sw", "aria-hidden": "true" }), (0, jsx_runtime_1.jsxs)("span", { className: "label", children: [thresholds_1.STATUS_LABEL.wn, " \u00B7 \u0434\u043E ", thresholds.wn] })] }), (0, jsx_runtime_1.jsxs)(styles_1.ScaleItem, { className: "dn", children: [(0, jsx_runtime_1.jsx)("span", { className: "sw", "aria-hidden": "true" }), (0, jsx_runtime_1.jsxs)("span", { className: "label", children: [thresholds_1.STATUS_LABEL.dn, " \u00B7 \u0432\u044B\u0448\u0435 ", thresholds.wn] })] }), (0, jsx_runtime_1.jsxs)(styles_1.ScaleItem, { className: "nd", children: [(0, jsx_runtime_1.jsx)("span", { className: "sw", "aria-hidden": "true" }), (0, jsx_runtime_1.jsx)("span", { className: "label", children: thresholds_1.STATUS_LABEL.nd })] })] }) })] }), (0, jsx_runtime_1.jsxs)(styles_1.Tooltip, { className: tooltip.show ? 'show' : '', style: { left: tooltip.x, top: tooltip.y }, role: "tooltip", "aria-hidden": !tooltip.show, children: [(0, jsx_runtime_1.jsxs)("div", { className: "tt-title", children: [(0, jsx_runtime_1.jsx)("span", { className: "dot", style: {
