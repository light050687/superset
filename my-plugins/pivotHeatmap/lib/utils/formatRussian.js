...
exports.formatRussianInt = formatRussianInt;
...
function formatRussianInt(value) {
    return new Intl.NumberFormat(RU_LOCALE, {
 ...
 */
function formatRussianPercent(pct, decimals = 1) {
 ...
 */
function formatRussianDeltaPercent(pct, decimals = 1) {
