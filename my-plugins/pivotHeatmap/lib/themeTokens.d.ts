 ...
 *
 * Values mirror the prototype `ref/heatmap-pivot-prototype.html` §03
 * and match kpiCard's tokens for visual consistency across plugins.
 */
export declare const LIGHT_TOKENS: {
    ...
    readonly dn: "#dc2626";
    readonly wn: "#ccb604";
    readonly upBg: "rgba(22, 163, 74, 0.10)";
    readonly dnBg: "rgba(220, 38, 38, 0.10)";
    readonly wnBg: "rgba(204, 182, 4, 0.14)";
...
export declare const DARK_TOKENS: {
    ...
    readonly dn: "#f87171";
    readonly wn: "#f8f571";
    readonly upBg: "rgba(52, 211, 153, 0.14)";
    readonly dnBg: "rgba(248, 113, 113, 0.16)";
    readonly wnBg: "rgba(248, 245, 113, 0.14)";
