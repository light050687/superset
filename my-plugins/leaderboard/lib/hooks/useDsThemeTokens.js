...
exports.useDsThemeTokens = useDsThemeTokens;
 ...
 */
function useDsThemeTokens() {
    const theme = (0, core_1.useTheme)();
    return (0, react_1.useMemo)(() => {
        const bg = theme?.colorBgContainer;
        const dark = isDarkColor(bg);
        const base = dark ? themeTokens_1.DARK_TOKENS : themeTokens_1.LIGHT_TOKENS;
        ...
        return {
            tokens: merged,
            cssVars: (0, themeTokens_1.toCssVars)(merged),
            isDark: dark,
        };
    }, [theme]);
}
