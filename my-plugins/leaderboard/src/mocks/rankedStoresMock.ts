...
export const CAUSE_TYPES: CauseType[] = [
...
export const WRITEOFF_TYPES: string[] = [
...
export const FORMATS_META: Record<FormatCode, FormatMeta> = {
  express: {
    id: 'express',
    name: 'Экспресс',
    colorKey: 'sky',
...
export const DIVISION_BY_FORMAT: Record<FormatCode, string> = {
...
export const FORMAT_ORDER: FormatCode[] = [
  'express',
  'minimarket',
  'super',
  'home',
