...
function EmptyStateInner({ title = 'Нет данных для отображения', description = 'Измените фильтры или проверьте соответствие колонок в настройках плагина. ' +
    ...
    return (_jsxs(StateContainer, { role: "status", "aria-live": "polite", children: [_jsxs("svg", { className: "state-icon", viewBox: "0 0 48 48", fill: "none", stroke: "currentColor", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": true, children: [_jsx("rect", { x: "6", y: "10", width: "36", height: "28", rx: "3" }), _jsx("line", { x1: "6", y1: "18", x2: "42", y2: "18" }), _jsx("line", { x1: "14", y1: "26", x2: "26", y2: "26" }), _jsx("line", { x1: "14", y1: "32", x2: "22", y2: "32" })] }), _jsx("div", { className: "state-title", children: title }), _jsx("div", { className: "state-desc", children: description })] }));
}
