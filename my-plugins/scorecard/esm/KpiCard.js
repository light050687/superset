...
formatValueA, formatValueB, formatDelta, detailTopN, detailPageSize, mockModeEnabled, mockPreset, mockCustomJson, }) {
    ...
    if (dataState === 'empty') {
        return (_jsx(KpiCardRoot, { ref: rootRef, width: width, height: height, "data-theme": isDarkMode ? 'dark' : 'light', role: "figure", "aria-label": `${headerText}: нет данных`, children: _jsxs(Card, { className: CARD_CLASS, "data-no-anim": "", children: [_jsx(CardHead, { children: _jsx(CardTitle, { children: headerText }) }), _jsxs(EmptyStateWrap, { children: [_jsx(EmptyStateIcon, { "aria-hidden": "true", children: "\u2014" }), _jsx(EmptyStateText, { children: "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0437\u0430 \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u044B\u0439 \u043F\u0435\u0440\u0438\u043E\u0434" })] })] }) }));
    }
    ...
    const hintTopRight = (_jsx(InfoHintTopRight, { children: _jsxs(InfoHint, { ariaLabel: "\u041F\u043E\u0434\u0441\u043A\u0430\u0437\u043A\u0430 \u043F\u043E \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044E", children: [hasDetail && (_jsxs(_Fragment, { children: [_jsxs("span", { className: "hi", children: [_jsx("kbd", { children: "Click" }), " \u2014 \u0434\u0435\u0442\u0430\u043B\u0438"] }), _jsx("span", { className: "hi-sep", "aria-hidden": "true" })] })), isDual && (_jsxs(_Fragment, { children: [_jsxs("span", { className: "hi", children: [_jsx("kbd", { children: toggleLabelA }), " / ", _jsx("kbd", { children: toggleLabelB }), " \u2014 \u043F\u0435\u0440\u0435\u043A\u043B\u044E\u0447\u0430\u0442\u0435\u043B\u044C"] }), _jsx("span", { className: "hi-sep", "aria-hidden": "true" })] })), _jsxs("span", { className: "hi", children: [_jsx("kbd", { children: "Right Click" }), " \u2014 \u043C\u0435\u043D\u044E \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0439"] })] }) }));
    return (_jsxs(KpiCardRoot, { ref: rootRef, width: width, height: height, "data-theme": isDarkMode ? 'dark' : 'light', role: "figure", "aria-label": `${headerText}: ${modeAView.value}`, children: [_jsx("style", { dangerouslySetInnerHTML: { __html: KEYFRAMES_CSS } }), _jsxs(Card, { className: CARD_CLASS, clickable: hasDetail, onClick: hasDetail
                    ? (e) => {
