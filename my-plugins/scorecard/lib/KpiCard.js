...
function ViewContent({ view, skipAnimation, }) {
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(AnimatedHero, { value: view.value, skipAnimation: skipAnimation }), view.subtitle && (0, jsx_runtime_1.jsx)(styles_1.Subtitle, { children: view.subtitle }), view.comparisons.length > 0 && ((0, jsx_runtime_1.jsx)(styles_1.ComparisonSection, { skipAnimation: skipAnimation, children: view.comparisons.map((cmp, i) => ((0, jsx_runtime_1.jsx)(ComparisonRow, { item: cmp, skipAnimation: skipAnimation }, `${cmp.label}-${i}`))) }))] }));
}
/* ── Main component ────────────────────────────────────────────── */
/**
...
formatValueA, formatValueB, formatDelta, detailTopN, detailPageSize, mockModeEnabled, mockPreset, mockCustomJson, }) {
    ...
    const hintTopRight = ((0, jsx_runtime_1.jsx)(InfoHint_1.InfoHintTopRight, { children: (0, jsx_runtime_1.jsxs)(InfoHint_1.InfoHint, { ariaLabel: "\u041F\u043E\u0434\u0441\u043A\u0430\u0437\u043A\u0430 \u043F\u043E \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044E", children: [hasDetail && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [(0, jsx_runtime_1.jsx)("kbd", { children: "Click" }), " \u2014 \u0434\u0435\u0442\u0430\u043B\u0438"] }), (0, jsx_runtime_1.jsx)("span", { className: "hi-sep", "aria-hidden": "true" })] })), isDual && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [(0, jsx_runtime_1.jsx)("kbd", { children: toggleLabelA }), " / ", (0, jsx_runtime_1.jsx)("kbd", { children: toggleLabelB }), " \u2014 \u043F\u0435\u0440\u0435\u043A\u043B\u044E\u0447\u0430\u0442\u0435\u043B\u044C"] }), (0, jsx_runtime_1.jsx)("span", { className: "hi-sep", "aria-hidden": "true" })] })), (0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [(0, jsx_runtime_1.jsx)("kbd", { children: "Right Click" }), " \u2014 \u043C\u0435\u043D\u044E \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0439"] })] }) }));
    return ((0, jsx_runtime_1.jsxs)(styles_1.KpiCardRoot, { ref: rootRef, width: width, height: height, "data-theme": isDarkMode ? 'dark' : 'light', role: "figure", "aria-label": `${headerText}: ${modeAView.value}`, children: [(0, jsx_runtime_1.jsx)("style", { dangerouslySetInnerHTML: { __html: styles_1.KEYFRAMES_CSS } }), (0, jsx_runtime_1.jsxs)(styles_1.Card, { className: styles_1.CARD_CLASS, clickable: hasDetail, onClick: hasDetail
                    ? (e) => {
...
class KpiCardErrorBoundary extends react_1.default.Component {
    ...
    render() {
        if (this.state.hasError) {
            ...
            return ((0, jsx_runtime_1.jsxs)(styles_1.KpiCardRoot, { width: width, height: height, "data-theme": "light", role: "figure", "aria-label": `${headerText}: ошибка`, children: [(0, jsx_runtime_1.jsx)("style", { dangerouslySetInnerHTML: { __html: styles_1.KEYFRAMES_CSS } }), (0, jsx_runtime_1.jsxs)(styles_1.Card, { className: styles_1.CARD_CLASS, "data-no-anim": "", children: [(0, jsx_runtime_1.jsx)(styles_1.CardHead, { children: (0, jsx_runtime_1.jsx)(styles_1.CardTitle, { children: headerText || 'KPI' }) }), (0, jsx_runtime_1.jsxs)(styles_1.EmptyStateWrap, { children: [(0, jsx_runtime_1.jsx)(styles_1.ErrorStateIcon, { "aria-hidden": "true" }), (0, jsx_runtime_1.jsx)(styles_1.EmptyStateText, { children: "\u041E\u0448\u0438\u0431\u043A\u0430 \u043E\u0442\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F" })] })] })] }));
        }
