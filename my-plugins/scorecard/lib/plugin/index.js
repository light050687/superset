 ...
 */
class SupersetPluginChartScorecard extends core_1.ChartPlugin {
    constructor() {
        super({
            buildQuery: buildQuery_1.default,
            controlPanel: controlPanel_1.default,
            loadChart: () => Promise.resolve().then(() => __importStar(require('../KpiCard'))),
...
exports.default = SupersetPluginChartScorecard;
