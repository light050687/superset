...
function createDeltaFormatter(autoRussian) {
    if (autoRussian) {
        return (n) => (0, formatRussian_1.formatRussianPercent)(n, true);
    }
    const d3Fmt = (0, core_1.getNumberFormatter)('+.1%');
    return (n) => d3Fmt(n);
}
...
function transformProps(chartProps) {
    ...
    const fmtMainA = (n) => (0, formatRussian_1.formatRussianSmartEx)(n, decimalsMainA, suffixMainA);
    const fmtComp1A = (n) => (0, formatRussian_1.formatRussianSmartEx)(n, decimalsComp1A, suffixComp1A);
    const fmtComp2A = (n) => (0, formatRussian_1.formatRussianSmartEx)(n, decimalsComp2A, suffixComp2A);
    const fmtDelta1A = (n) => (0, formatRussian_1.formatRussianDeltaAbsEx)(n, decimalsDelta1A, suffixDelta1A);
    const fmtDelta2A = (n) => (0, formatRussian_1.formatRussianDeltaAbsEx)(n, decimalsDelta2A, suffixDelta2A);
    const fmtMainB = (n) => (0, formatRussian_1.formatRussianSmartEx)(n, decimalsMainB, suffixMainB);
    const fmtComp1B = (n) => (0, formatRussian_1.formatRussianSmartEx)(n, decimalsComp1B, suffixComp1B);
    const fmtComp2B = (n) => (0, formatRussian_1.formatRussianSmartEx)(n, decimalsComp2B, suffixComp2B);
    const fmtDelta1B = (n) => (0, formatRussian_1.formatRussianDeltaAbsEx)(n, decimalsDelta1B, suffixDelta1B);
    const fmtDelta2B = (n) => (0, formatRussian_1.formatRussianDeltaAbsEx)(n, decimalsDelta2B, suffixDelta2B);
    ...
    if (mockModeEnabled) {
        const preset = (0, presets_1.getPreset)(formData.mockPreset, formData.mockCustomJson);
        const isDarkMode = (() => {
    ...
    const metricALabel = formData.metricA ? (0, core_1.getMetricLabel)(formData.metricA) : '';
    ...
    const delta1ALabel = formData.metricDelta1A ? (0, core_1.getMetricLabel)(formData.metricDelta1A) : null;
    const deltaValue1A = delta1ALabel ? extractMetricValue(summaryData, delta1ALabel) : null;
    const delta2ALabel = formData.metricDelta2A ? (0, core_1.getMetricLabel)(formData.metricDelta2A) : null;
    ...
    const metricBLabel = hasModeB ? (0, core_1.getMetricLabel)(formData.metricB) : '';
    ...
    const delta1BLabel = hasModeB && formData.metricDelta1B ? (0, core_1.getMetricLabel)(formData.metricDelta1B) : null;
    const deltaValue1B = delta1BLabel ? extractMetricValue(summaryData, delta1BLabel) : null;
    const delta2BLabel = hasModeB && formData.metricDelta2B ? (0, core_1.getMetricLabel)(formData.metricDelta2B) : null;
    ...
    const detailQueryParams = hasGroupby
        ? {
            ...
            metricsA,
            metricsB,
            metricLabelsA: metricsA.map(m => (0, core_1.getMetricLabel)(m)),
            metricLabelsB: metricsB.map(m => (0, core_1.getMetricLabel)(m)),
            timeRange: (fdExt.timeRange ?? fdExt.time_range),
            granularity: (fdExt.granularitySqla ?? fdExt.granularity_sqla),
