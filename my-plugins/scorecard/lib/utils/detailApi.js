...
exports.resolveSortTarget = resolveSortTarget;
exports.buildGroupsPayload = buildGroupsPayload;
exports.buildCountPayload = buildCountPayload;
exports.buildChildrenPayload = buildChildrenPayload;
exports.buildExportPayload = buildExportPayload;
exports.formatServerRow = formatServerRow;
...
function findMetricByLabel(metrics, label) {
    return metrics.find((m) => (0, core_1.getMetricLabel)(m) === label);
}
/**
 ...
 */
function resolveSortTarget(sortColumn, groupbyCol, metricLabel, comp1Label, comp2Label, delta1Label, delta2Label) {
    switch (sortColumn) {
        case 'name':
            return groupbyCol;
        case 'value':
 ...
 */
function buildGroupsPayload(params) {
 ...
 */
function buildCountPayload(params) {
 ...
 */
function buildChildrenPayload(params) {
 ...
 */
function buildExportPayload(queryParams, activeMode, groupbyCol, childCol, metricLabel, searchQuery, searchScope, exactMatch = false) {
    const isA = activeMode === 'a';
    const metrics = isA ? queryParams.metricsA : queryParams.metricsB;
    const filters = [...queryParams.filters];
    const trimmed = searchQuery.trim();
 ...
 */
function formatServerRow(row, nameCol, metricLabel, comp1Label, comp2Label, delta1Label, delta2Label, opts) {
    ...
    if (isPercentMode) {
        ...
        effectiveFormatValue = (n) => (0, formatRussian_1.formatRussianPercent)(n, false);
        effectiveFormatDelta = (n) => (0, formatRussian_1.formatRussianPP)(n);
    }
    const rawMetric = metric;
    const summary = (0, aggregation_1.formatRow)(name, metric, comp1, comp2, isPercentMode, effectiveFormatValue, effectiveFormatDelta, opts.colorScheme1, opts.colorScheme2, opts.enableComp1, opts.enableComp2, opts.deltaFormat1, opts.deltaFormat2, opts.fmtComp1, opts.fmtComp2, opts.fmtDelta1, opts.fmtDelta2, opts.showDelta1, opts.showDelta2, delta1Raw, delta2Raw);
