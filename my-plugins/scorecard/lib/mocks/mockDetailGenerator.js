...
exports.generateMockGroups = generateMockGroups;
exports.generateMockChildren = generateMockChildren;
/**
 ...
 */
function paretoDistribute(total, count, seed) {
    if (count === 0)
        return [];
 ...
 */
function generateGroupNames(col, count, seed) {
 ...
 */
function generateMockGroups(params) {
...
//# sourceMappingURL=mockDetailGenerator.js.map