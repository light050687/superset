...
exports.MOCK_PRESETS = void 0;
exports.parseCustomPreset = parseCustomPreset;
exports.getPreset = getPreset;
exports.MOCK_PRESETS = {
    revenue: {
        label: 'Выручка',
        mainA: 12400000000,
        comp1A: 11200000000,
...
function parseCustomPreset(json) {
    try {
        ...
        return exports.MOCK_PRESETS.empty;
    }
}
/**
 * Get preset by key, falling back to 'revenue'.
 */
function getPreset(key, customJson) {
    if (key === 'custom')
        return parseCustomPreset(customJson ?? '{}');
    return exports.MOCK_PRESETS[key ?? 'revenue'] ?? exports.MOCK_PRESETS.revenue;
}
