                ...
                [
                    {
                        ...
                        config: {
                            ...
                            description: t('Показывает тестовые данные из прототипа для согласования дизайна. ' +
                ...
                [
                    {
                        ...
                        config: {
                            ...
                            description: t('Формат: {"totalRevenue": 88500, "categories": [{"id":"...", ' +
                ...
                [
                    {
                        ...
                        config: {
                            ...
                            description: t('Колонка второго уровня. Если задана — включается drill-down. ' +
                ...
                [
                    {
                        ...
                        config: {
                            ...
                            description: t('Опционально. Метрика, чья сумма по всем строкам используется ' +
                ...
                [
                    {
                        ...
                        config: {
                            ...
                            description: t('Сколько цифр показывать после запятой в hero-числе ' +
                ...
                [
                    {
                        ...
                        config: {
                            ...
                            description: t('Для категорий без явного маппинга применяется автопалитра: ' +
