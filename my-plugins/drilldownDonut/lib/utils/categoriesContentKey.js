...
exports.getCategoriesIdKey = getCategoriesIdKey;
exports.getCategoriesContentKey = getCategoriesContentKey;
/**
 ...
 *    `categories` ссылки.
 */
function getCategoriesIdKey(categories) {
    return categories.map(c => c.id).join('|');
}
function getCategoriesContentKey(categories) {
    return categories
        .map(c => {
