...
function buildOption(args) {
    ...
    return {
        ...
        tooltip: {
            ...
            textStyle: { color: t.ink, fontFamily: themeTokens_1.FONTS.text, fontSize: 11 },
            formatter: (p) => {
                ...
                const headerStyle = `font:700 13px ${themeTokens_1.FONTS.text};color:${t.ink};margin-bottom:8px;padding-bottom:8px;border-bottom:1px solid rgba(128,128,128,0.25);line-height:1.3`;
                const rowStyle = `font-family:${themeTokens_1.FONTS.mono};line-height:1.5;display:flex;justify-content:space-between;gap:12px`;
