...
function StructureDonut(props) {
    ...
    const [hintOpen, setHintOpen] = (0, react_1.useState)(false);
    const hintTriggerRef = (0, react_1.useRef)(null);
    ...
    const hintContent = (0, react_1.useMemo)(() => {
        ...
        const rightClickHint = ((0, jsx_runtime_1.jsx)("span", { className: "hi", children: (0, jsx_runtime_1.jsx)("span", { children: "Right Click \u2014 \u043C\u0435\u043D\u044E \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0439" }) }));
        if (level === 'drilled') {
            // Drilled: «◂ или Esc — назад» (стрелка в breadcrumb тоже работает).
            // Символ ◂ обёрнут в .hi-arrow — крупнее остального текста (18px).
            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [(0, jsx_runtime_1.jsx)(IconBack, {}), (0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("span", { className: "hi-arrow", "aria-hidden": "true", children: "\u25C2" }), " \u0438\u043B\u0438 Esc \u2014 \u043D\u0430\u0437\u0430\u0434"] })] }), (0, jsx_runtime_1.jsx)("span", { className: "hi-sep", "aria-hidden": "true" }), rightClickHint] }));
        }
        if (selectedIdx != null) {
            // Selected (на root): подсказка про Ctrl+Click для drill'а.
            // Между хинтами — вертикальный разделитель .hi-sep (не SVG).
            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [hasSubcategories && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: "hi", children: (0, jsx_runtime_1.jsx)("span", { children: "Ctrl+Click \u2014 \u0432\u0433\u043B\u0443\u0431\u044C" }) }), (0, jsx_runtime_1.jsx)("span", { className: "hi-sep", "aria-hidden": "true" })] })), (0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [(0, jsx_runtime_1.jsx)(IconBack, {}), (0, jsx_runtime_1.jsx)("span", { children: "Esc \u2014 \u0441\u043D\u044F\u0442\u044C" })] }), (0, jsx_runtime_1.jsx)("span", { className: "hi-sep", "aria-hidden": "true" }), rightClickHint] }));
        }
        // Root, ничего не выбрано: дополнительно про Ctrl+Click.
        return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("span", { className: "hi", children: [(0, jsx_runtime_1.jsx)(IconClick, {}), (0, jsx_runtime_1.jsx)("span", { children: "\u043A\u043B\u0438\u043A \u2014 \u0432\u044B\u0431\u0440\u0430\u0442\u044C \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044E" })] }), hasSubcategories && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: "hi-sep", "aria-hidden": "true" }), (0, jsx_runtime_1.jsx)("span", { className: "hi", children: (0, jsx_runtime_1.jsx)("span", { children: "Ctrl+Click \u2014 \u0432\u0433\u043B\u0443\u0431\u044C" }) })] })), (0, jsx_runtime_1.jsx)("span", { className: "hi-sep", "aria-hidden": "true" }), rightClickHint] }));
    ...
    return ((0, jsx_runtime_1.jsxs)(styles_1.StructureDonutRoot, { "data-theme": isDarkMode ? 'dark' : 'light', width: width, height: height, children: [(0, jsx_runtime_1.jsx)("style", { dangerouslySetInnerHTML: { __html: styles_1.KEYFRAMES_CSS } }), (0, jsx_runtime_1.jsxs)(styles_1.Card, { role: "region", "aria-labelledby": "sd-title", children: [(0, jsx_runtime_1.jsxs)(styles_1.CardHead, { children: [(0, jsx_runtime_1.jsxs)(styles_1.Title, { children: [(0, jsx_runtime_1.jsxs)(styles_1.HeaderText, { id: "sd-title", children: [headerText, mockModeEnabled && (0, jsx_runtime_1.jsx)(styles_1.MockBadge, { children: "\u0422\u0415\u0421\u0422" })] }), (0, jsx_runtime_1.jsx)(styles_1.Breadcrumb, { children: breadcrumbContent }), dataState === 'partial' && ((0, jsx_runtime_1.jsx)(styles_1.PartialChip, { role: "status", "aria-live": "polite", children: "\u26A0 \u041F\u043E\u043A\u0430\u0437\u0430\u043D\u044B \u043F\u0435\u0440\u0432\u044B\u0435 500 \u0441\u0442\u0440\u043E\u043A" })), dataState === 'stale' && ((0, jsx_runtime_1.jsx)(styles_1.StaleBadge, { role: "status", "aria-live": "polite", children: "\u21BB \u0414\u0430\u043D\u043D\u044B\u0435 \u0438\u0437 \u043A\u044D\u0448\u0430" }))] }), (0, jsx_runtime_1.jsx)(styles_1.Controls, { children: (0, jsx_runtime_1.jsxs)(styles_1.UnitToggle, { role: "radiogroup", "aria-label": "\u0415\u0434\u0438\u043D\u0438\u0446\u044B \u0438\u0437\u043C\u0435\u0440\u0435\u043D\u0438\u044F", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", role: "radio", className: unit === 'rub' ? 'on' : '', "aria-checked": unit === 'rub', onClick: () => setUnit('rub'), title: "\u0412 \u0440\u0443\u0431\u043B\u044F\u0445", children: "\u20BD" }), (0, jsx_runtime_1.jsx)("button", { type: "button", role: "radio", className: unit === 'pct' ? 'on' : '', "aria-checked": unit === 'pct', onClick: () => setUnit('pct'), title: "\u041F\u0440\u043E\u0446\u0435\u043D\u0442 \u043E\u0442 \u043E\u0431\u043E\u0440\u043E\u0442\u0430", children: "%" })] }) })] }), dataState === 'empty' && ((0, jsx_runtime_1.jsx)(styles_1.EmptyOverlay, { role: "status", children: "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0437\u0430 \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u044B\u0439 \u043F\u0435\u0440\u0438\u043E\u0434" })), dataState === 'error' && ((0, jsx_runtime_1.jsxs)(styles_1.ErrorOverlay, { role: "alert", children: [(0, jsx_runtime_1.jsx)("div", { children: "\u26A0 \u041E\u0448\u0438\u0431\u043A\u0430 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u0434\u0430\u043D\u043D\u044B\u0445" }), (0, jsx_runtime_1.jsx)("div", { className: "sd-error-sub", children: errorMessage ?? 'Проверьте настройки запроса' })] })), showChart && (
                    ...
                    (0, jsx_runtime_1.jsxs)(styles_1.ChartWrap, { children: [(0, jsx_runtime_1.jsx)(DonutChartInner, { width: width, height: height, dataState: dataState, categories: categories, hasSubcategories: hasSubcategories, totalRevenue: totalRevenue, padAngle: padAngle, borderRadius: borderRadius, showOuterLabelsPct: showOuterLabelsPct, rubDecimals: rubDecimals, unit: unit, level: level, drilledId: drilledId, selectedIdx: selectedIdx, hidden: hidden, tokens: tokens, ariaLabel: donutAriaLabel, onSelect: setSelectedIdx, onDrill: handleDrill }, `donut-${level}-${drilledId ?? 'root'}`), (0, jsx_runtime_1.jsx)(styles_1.HeroOverlay, { "aria-hidden": "true", children: (() => {
                                ...
                                })() })] }, `chart-${level}-${drilledId ?? 'root'}`)), (0, jsx_runtime_1.jsxs)(styles_1.Footer, { children: [(0, jsx_runtime_1.jsx)(styles_1.Legend, { role: "group", "aria-label": "\u041B\u0435\u0433\u0435\u043D\u0434\u0430", children: currentItems.map((it) => ((0, jsx_runtime_1.jsxs)(styles_1.LegendChip, { className: hidden.has(it.id) ? 'off' : '', tabIndex: 0, role: "button", "aria-pressed": !hidden.has(it.id), "aria-label": `${hidden.has(it.id) ? 'Показать' : 'Скрыть'} ${it.name}`, onClick: () => toggleHidden(it.id), onKeyDown: (e) => {
                                        if (e.key === 'Enter' || e.key === ' ') {
                                            e.preventDefault();
                                            toggleHidden(it.id);
                                        }
                                    }, children: [(0, jsx_runtime_1.jsx)("span", { className: "lg-dot", style: { background: it.color } }), (0, jsx_runtime_1.jsx)("span", { className: "lg-l", children: it.name })] }, it.id))) }), (0, jsx_runtime_1.jsxs)(styles_1.HintTrigger, { ref: hintTriggerRef, type: "button", "aria-label": "\u041F\u043E\u0434\u0441\u043A\u0430\u0437\u043A\u0430 \u043F\u043E \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044E", "aria-expanded": hintOpen, onClick: (e) => {
                                    e.stopPropagation();
                                    setHintOpen((v) => !v);
                                }, "data-open": hintOpen ? '' : undefined, children: [(0, jsx_runtime_1.jsx)(IconInfo, {}), (0, jsx_runtime_1.jsx)(styles_1.HintTooltip, { role: "tooltip", children: hintContent })] })] })] })] }));
}
