...
const hasGroupbyCategory = ({ controls }: ControlsMap): boolean => {
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Колонка для разбивки на стек-режимах (Стек-бары / Стек-площадь). ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Количество отображаемых категорий. Остальные сливаются в «Прочее».',
              ),
              default: 5,
              renderTrigger: true,
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                '-1 = авто. Масштаб подставляется автоматически (тыс / млн / млрд).',
              ),
              default: -1,
              renderTrigger: true,
            },
        ...
        [
          {
            ...
            config: {
              ...
              label: t('Единица'),
              description: t(
                'Добавляется после числа. Например "₽", "шт", "кг". Масштаб (тыс/млн/млрд) подставляется автоматически.',
              ),
              default: '₽',
              renderTrigger: true,
            },
