 ...
 */
export default function buildQuery(formData: WriteoffsTSFormData) {
  const {
    metric_fact,
    metric_plan,
    metric_py,
  ...
  const groupbyCategory = (fd.groupby_category ?? fd.groupbyCategory) as string | undefined;
  ...
  return buildQueryContext(formData, baseQueryObject => {
    ...
    const queries: unknown[] = [seriesQuery];
    ...
    return queries as Array<typeof seriesQuery>;
  });
}
