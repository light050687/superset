...
import { Root, Card, CardHead, TitleWrap, Title, Breadcrumb, BreadcrumbBack, Controls, IconButton, UnitToggleGroup, UnitButton, DropdownRoot, DropdownPanel, DropdownMenu, DropdownItem, DropdownItemIcon, ChartWrap, ChartInner, BrushButton, CardFooter, Hint, HintItem, LegendRow, LegendItem, LegendMark, LegendLabel, LegendSeparator, FooterSpacer, SkeletonWrap, SkeletonBlock, EmptyStateWrap, EmptyStateIcon, EmptyStateText, ErrorStateWrap, ErrorStateIcon, ErrorStateText, MockBadge, PartialBadge, StaleBar, SrLive, KEYFRAMES_CSS, CARD_CLASS, } from './styles';
...
function WriteoffsTimeseriesInner(props) {
    ...
    if (dataState === 'loading') {
        return (_jsxs(Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', className: CARD_CLASS, children: [_jsx("style", { children: KEYFRAMES_CSS }), _jsx(Card, { children: _jsxs(SkeletonWrap, { children: [_jsx(SkeletonBlock, { w: "40%", h: 14 }), _jsx(SkeletonBlock, { h: 200 }), _jsx(SkeletonBlock, { w: "60%", h: 12 })] }) })] }));
    }
    if (dataState === 'error') {
        return (_jsxs(Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', className: CARD_CLASS, children: [_jsx("style", { children: KEYFRAMES_CSS }), _jsx(Card, { children: _jsxs(ErrorStateWrap, { children: [_jsx(ErrorStateIcon, {}), _jsx(ErrorStateText, { children: errorMessage || 'Ошибка отображения' })] }) })] }));
    }
    if (dataState === 'empty') {
        return (_jsxs(Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', className: CARD_CLASS, children: [_jsx("style", { children: KEYFRAMES_CSS }), _jsx(SrLive, { "aria-live": "polite", children: "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445" }), _jsx(Card, { children: _jsxs(EmptyStateWrap, { children: [_jsx(EmptyStateIcon, { children: "\u2014" }), _jsxs(EmptyStateText, { children: ["\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0437\u0430 \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u044B\u0439 \u043F\u0435\u0440\u0438\u043E\u0434.", _jsx("br", {}), "\u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0444\u0438\u043B\u044C\u0442\u0440\u044B \u0438 \u0432\u0440\u0435\u043C\u0435\u043D\u043D\u043E\u0439 \u0434\u0438\u0430\u043F\u0430\u0437\u043E\u043D."] })] }) })] }));
    }
