...
import { Root, Card, CardHead, TitleWrap, Title, Breadcrumb, BreadcrumbBack, Controls, IconButton, UnitToggleGroup, UnitButton, DropdownRoot, DropdownMenu, DropdownItem, DropdownItemRow, DropdownItemIcon, ChartWrap, ChartInner, BrushButton, CardFooter, Hint, HintItem, LegendRow, LegendItem, LegendMark, LegendLabel, LegendSeparator, FooterSpacer, SkeletonWrap, SkeletonBlock, EmptyStateWrap, EmptyStateIcon, EmptyStateText, ErrorStateWrap, ErrorStateIcon, ErrorStateText, MockBadge, PartialBadge, StaleBar, SrLive, KEYFRAMES_CSS, } from './styles';
...
function Dropdown({ value, options, onChange, ariaLabel, }) {
    ...
    return (_jsxs(DropdownRoot, { ref: rootRef, children: [_jsx(IconButton, { type: "button", active: open, "aria-haspopup": "listbox", "aria-expanded": open, "aria-label": ariaLabel, onClick: () => setOpen(o => !o), children: active.icon }), open && (_jsx(DropdownMenu, { role: "listbox", "aria-label": ariaLabel, children: options.map(opt => (_jsx(DropdownItem, { type: "button", active: opt.value === value, role: "option", "aria-selected": opt.value === value, onClick: () => {
                        onChange(opt.value);
                        setOpen(false);
                    }, children: _jsxs(DropdownItemRow, { children: [_jsx(DropdownItemIcon, { children: opt.icon }), _jsx("span", { children: opt.label })] }) }, opt.value))) }))] }));
}
/* ──────────────── Legend helpers ──────────────── */
...
function WriteoffsTimeseriesInner(props) {
    ...
    if (dataState === 'loading') {
        return (_jsxs(Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', children: [_jsx("style", { children: KEYFRAMES_CSS }), _jsx(Card, { children: _jsxs(SkeletonWrap, { children: [_jsx(SkeletonBlock, { w: "40%", h: 14 }), _jsx(SkeletonBlock, { h: 200 }), _jsx(SkeletonBlock, { w: "60%", h: 12 })] }) })] }));
    }
    if (dataState === 'error') {
        return (_jsxs(Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', children: [_jsx("style", { children: KEYFRAMES_CSS }), _jsx(Card, { children: _jsxs(ErrorStateWrap, { children: [_jsx(ErrorStateIcon, {}), _jsx(ErrorStateText, { children: errorMessage || 'Ошибка отображения' })] }) })] }));
    }
    if (dataState === 'empty') {
        return (_jsxs(Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', children: [_jsx("style", { children: KEYFRAMES_CSS }), _jsx(SrLive, { "aria-live": "polite", children: "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445" }), _jsx(Card, { children: _jsxs(EmptyStateWrap, { children: [_jsx(EmptyStateIcon, { children: "\u2014" }), _jsxs(EmptyStateText, { children: ["\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0437\u0430 \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u044B\u0439 \u043F\u0435\u0440\u0438\u043E\u0434.", _jsx("br", {}), "\u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0444\u0438\u043B\u044C\u0442\u0440\u044B \u0438 \u0432\u0440\u0435\u043C\u0435\u043D\u043D\u043E\u0439 \u0434\u0438\u0430\u043F\u0430\u0437\u043E\u043D."] })] }) })] }));
    }
    ...
    const liveMessage = dataState === 'populated'
        ...
        : isPartial
            ...
            : isStale
                ? 'Данные устарели'
                : '';
    return (_jsxs(Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', role: "figure", "aria-label": headerText, children: [_jsx("style", { children: KEYFRAMES_CSS }), _jsx(SrLive, { "aria-live": "polite", "aria-atomic": "true", children: liveMessage }), _jsxs(Card, { children: [isStale && _jsx(StaleBar, { "aria-hidden": "true" }), _jsxs(CardHead, { children: [_jsxs(TitleWrap, { children: [_jsxs(Title, { children: [headerText, mockModeEnabled && (_jsxs(_Fragment, { children: [' ', _jsx(MockBadge, { children: "MOCK" })] })), isPartial && (_jsxs(_Fragment, { children: [' ', _jsx(PartialBadge, { title: "\u0427\u0430\u0441\u0442\u044C \u0434\u0430\u043D\u043D\u044B\u0445 \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0430", children: "\u0427\u0430\u0441\u0442\u0438\u0447\u043D\u043E" })] }))] }), _jsxs(Breadcrumb, { children: [!isFullRange && (_jsx(BreadcrumbBack, { type: "button", "aria-label": "\u0412\u0435\u0440\u043D\u0443\u0442\u044C\u0441\u044F \u043A\u043E \u0432\u0441\u0435\u043C\u0443 \u0434\u0438\u0430\u043F\u0430\u0437\u043E\u043D\u0443", title: "\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C \u0432\u044B\u0434\u0435\u043B\u0435\u043D\u0438\u0435 (Esc)", onClick: resetSelection, children: "\u25C2" })), _jsxs("span", { children: [hierarchyText, " \u00B7 ", rangeText] })] })] }), _jsxs(Controls, { children: [_jsx(Dropdown, { ariaLabel: "\u0413\u0440\u0430\u043D\u0443\u043B\u044F\u0440\u043D\u043E\u0441\u0442\u044C", value: gran, onChange: (v) => {
                                            setGran(v);
                                            if (v === 'year' || v === 'month') {
