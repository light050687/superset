...
function Dropdown({ value, options, onChange, ariaLabel, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(styles_1.DropdownRoot, { ref: rootRef, children: [(0, jsx_runtime_1.jsx)(styles_1.IconButton, { type: "button", active: open, "aria-haspopup": "listbox", "aria-expanded": open, "aria-label": ariaLabel, onClick: () => setOpen(o => !o), children: active.icon }), open && ((0, jsx_runtime_1.jsx)(styles_1.DropdownMenu, { role: "listbox", "aria-label": ariaLabel, children: options.map(opt => ((0, jsx_runtime_1.jsx)(styles_1.DropdownItem, { type: "button", active: opt.value === value, role: "option", "aria-selected": opt.value === value, onClick: () => {
                        onChange(opt.value);
                        setOpen(false);
                    }, children: (0, jsx_runtime_1.jsxs)(styles_1.DropdownItemRow, { children: [(0, jsx_runtime_1.jsx)(styles_1.DropdownItemIcon, { children: opt.icon }), (0, jsx_runtime_1.jsx)("span", { children: opt.label })] }) }, opt.value))) }))] }));
}
/* ──────────────── Legend helpers ──────────────── */
...
function WriteoffsTimeseriesInner(props) {
    const { headerText, dataState, errorMessage, timePoints, categories, defaultMode, defaultGranularity, defaultUnit, showBrushButton, enableDrillDown, formatValue, formatAxis, formatPct, seriesLabels, isDarkMode, mockModeEnabled, } = props;
    ...
    if (dataState === 'loading') {
        return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsx)(styles_1.Card, { children: (0, jsx_runtime_1.jsxs)(styles_1.SkeletonWrap, { children: [(0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { w: "40%", h: 14 }), (0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { h: 200 }), (0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { w: "60%", h: 12 })] }) })] }));
    }
    if (dataState === 'error') {
        return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsx)(styles_1.Card, { children: (0, jsx_runtime_1.jsxs)(styles_1.ErrorStateWrap, { children: [(0, jsx_runtime_1.jsx)(styles_1.ErrorStateIcon, {}), (0, jsx_runtime_1.jsx)(styles_1.ErrorStateText, { children: errorMessage || 'Ошибка отображения' })] }) })] }));
    }
    if (dataState === 'empty') {
        return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsx)(styles_1.SrLive, { "aria-live": "polite", children: "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445" }), (0, jsx_runtime_1.jsx)(styles_1.Card, { children: (0, jsx_runtime_1.jsxs)(styles_1.EmptyStateWrap, { children: [(0, jsx_runtime_1.jsx)(styles_1.EmptyStateIcon, { children: "\u2014" }), (0, jsx_runtime_1.jsxs)(styles_1.EmptyStateText, { children: ["\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0437\u0430 \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u044B\u0439 \u043F\u0435\u0440\u0438\u043E\u0434.", (0, jsx_runtime_1.jsx)("br", {}), "\u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0444\u0438\u043B\u044C\u0442\u0440\u044B \u0438 \u0432\u0440\u0435\u043C\u0435\u043D\u043D\u043E\u0439 \u0434\u0438\u0430\u043F\u0430\u0437\u043E\u043D."] })] }) })] }));
    }
    ...
    const liveMessage = dataState === 'populated'
        ...
        : isPartial
            ...
            : isStale
                ? 'Данные устарели'
                : '';
    return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', role: "figure", "aria-label": headerText, children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsx)(styles_1.SrLive, { "aria-live": "polite", "aria-atomic": "true", children: liveMessage }), (0, jsx_runtime_1.jsxs)(styles_1.Card, { children: [isStale && (0, jsx_runtime_1.jsx)(styles_1.StaleBar, { "aria-hidden": "true" }), (0, jsx_runtime_1.jsxs)(styles_1.CardHead, { children: [(0, jsx_runtime_1.jsxs)(styles_1.TitleWrap, { children: [(0, jsx_runtime_1.jsxs)(styles_1.Title, { children: [headerText, mockModeEnabled && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [' ', (0, jsx_runtime_1.jsx)(styles_1.MockBadge, { children: "MOCK" })] })), isPartial && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [' ', (0, jsx_runtime_1.jsx)(styles_1.PartialBadge, { title: "\u0427\u0430\u0441\u0442\u044C \u0434\u0430\u043D\u043D\u044B\u0445 \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0430", children: "\u0427\u0430\u0441\u0442\u0438\u0447\u043D\u043E" })] }))] }), (0, jsx_runtime_1.jsxs)(styles_1.Breadcrumb, { children: [!isFullRange && ((0, jsx_runtime_1.jsx)(styles_1.BreadcrumbBack, { type: "button", "aria-label": "\u0412\u0435\u0440\u043D\u0443\u0442\u044C\u0441\u044F \u043A\u043E \u0432\u0441\u0435\u043C\u0443 \u0434\u0438\u0430\u043F\u0430\u0437\u043E\u043D\u0443", title: "\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C \u0432\u044B\u0434\u0435\u043B\u0435\u043D\u0438\u0435 (Esc)", onClick: resetSelection, children: "\u25C2" })), (0, jsx_runtime_1.jsxs)("span", { children: [hierarchyText, " \u00B7 ", rangeText] })] })] }), (0, jsx_runtime_1.jsxs)(styles_1.Controls, { children: [(0, jsx_runtime_1.jsx)(Dropdown, { ariaLabel: "\u0413\u0440\u0430\u043D\u0443\u043B\u044F\u0440\u043D\u043E\u0441\u0442\u044C", value: gran, onChange: (v) => {
                                            setGran(v);
                                            if (v === 'year' || v === 'month') {
