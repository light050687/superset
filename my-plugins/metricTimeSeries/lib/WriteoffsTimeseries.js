...
function WriteoffsTimeseriesInner(props) {
    ...
    if (dataState === 'loading') {
        return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', className: styles_1.CARD_CLASS, children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsx)(styles_1.Card, { children: (0, jsx_runtime_1.jsxs)(styles_1.SkeletonWrap, { children: [(0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { w: "40%", h: 14 }), (0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { h: 200 }), (0, jsx_runtime_1.jsx)(styles_1.SkeletonBlock, { w: "60%", h: 12 })] }) })] }));
    }
    if (dataState === 'error') {
        return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', className: styles_1.CARD_CLASS, children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsx)(styles_1.Card, { children: (0, jsx_runtime_1.jsxs)(styles_1.ErrorStateWrap, { children: [(0, jsx_runtime_1.jsx)(styles_1.ErrorStateIcon, {}), (0, jsx_runtime_1.jsx)(styles_1.ErrorStateText, { children: errorMessage || 'Ошибка отображения' })] }) })] }));
    }
    if (dataState === 'empty') {
        return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { width: props.width, height: props.height, "data-theme": isDarkMode ? 'dark' : 'light', className: styles_1.CARD_CLASS, children: [(0, jsx_runtime_1.jsx)("style", { children: styles_1.KEYFRAMES_CSS }), (0, jsx_runtime_1.jsx)(styles_1.SrLive, { "aria-live": "polite", children: "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445" }), (0, jsx_runtime_1.jsx)(styles_1.Card, { children: (0, jsx_runtime_1.jsxs)(styles_1.EmptyStateWrap, { children: [(0, jsx_runtime_1.jsx)(styles_1.EmptyStateIcon, { children: "\u2014" }), (0, jsx_runtime_1.jsxs)(styles_1.EmptyStateText, { children: ["\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0437\u0430 \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u044B\u0439 \u043F\u0435\u0440\u0438\u043E\u0434.", (0, jsx_runtime_1.jsx)("br", {}), "\u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0444\u0438\u043B\u044C\u0442\u0440\u044B \u0438 \u0432\u0440\u0435\u043C\u0435\u043D\u043D\u043E\u0439 \u0434\u0438\u0430\u043F\u0430\u0437\u043E\u043D."] })] }) })] }));
    }
