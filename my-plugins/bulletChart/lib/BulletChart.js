...
class BulletErrorBoundary extends React.Component {
    ...
    render() {
        if (this.state.hasError) {
            return ((0, jsx_runtime_1.jsxs)(styles_1.StateOverlay, { role: "alert", children: [(0, jsx_runtime_1.jsx)("span", { style: { color: 'var(--dn)' }, children: "\u041E\u0448\u0438\u0431\u043A\u0430 \u043E\u0442\u0440\u0438\u0441\u043E\u0432\u043A\u0438 bullet-\u0447\u0430\u0440\u0442\u0430" }), (0, jsx_runtime_1.jsx)("span", { style: { fontSize: 10, color: 'var(--g500)' }, children: this.state.message })] }));
        }
...
const BulletChartInner = props => {
    ...
    // ── Render ──
    return ((0, jsx_runtime_1.jsxs)(styles_1.Root, { ref: rootRef, className: styles_1.ROOT_CLASS, isDarkMode: isDarkMode, style: { width, height }, "data-theme": isDarkMode ? 'dark' : 'light', children: [(0, jsx_runtime_1.jsx)("style", { dangerouslySetInnerHTML: { __html: styles_1.KEYFRAMES_CSS } }), (0, jsx_runtime_1.jsxs)(styles_1.Card, { role: "region", "aria-label": headerText, children: [(0, jsx_runtime_1.jsxs)(styles_1.CardHead, { children: [(0, jsx_runtime_1.jsxs)(styles_1.TitleBlock, { children: [(0, jsx_runtime_1.jsx)(styles_1.CardTitle, { children: headerText }), (0, jsx_runtime_1.jsxs)(styles_1.CardSub, { children: [subheaderText ? (0, jsx_runtime_1.jsx)("span", { children: subheaderText }) : null, totalStores != null ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: "dot" }), (0, jsx_runtime_1.jsx)("span", { className: "strong", children: (0, format_1.formatStoresCount)(totalStores) })] })) : null, mockModeEnabled ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: "dot" }), (0, jsx_runtime_1.jsx)("span", { children: "\u0420\u0435\u0436\u0438\u043C \u043F\u0440\u043E\u0435\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F" })] })) : null] })] }), rows.length > 0 ? ((0, jsx_runtime_1.jsxs)(styles_1.Controls, { children: [(0, jsx_runtime_1.jsx)(SortMenu_1.default, { value: sortBy, onChange: setSortBy }), (0, jsx_runtime_1.jsxs)(styles_1.FilterPill, { type: "button", active: filterBad, "aria-pressed": filterBad, onClick: () => setFilterBad(v => !v), title: "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u0445\u0443\u0436\u0435 \u043F\u043B\u0430\u043D\u0430", children: [(0, jsx_runtime_1.jsxs)("svg", { viewBox: "0 0 14 14", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", children: [(0, jsx_runtime_1.jsx)("path", { d: "M7 2 L13 12 L1 12 Z" }), (0, jsx_runtime_1.jsx)("line", { x1: "7", y1: "6", x2: "7", y2: "9" }), (0, jsx_runtime_1.jsx)("line", { x1: "7", y1: "11", x2: "7", y2: "11.5" })] }), (0, jsx_runtime_1.jsx)("span", { children: "\u0425\u0443\u0436\u0435 \u043F\u043B\u0430\u043D\u0430" })] })] })) : null] }), dataState === 'loading' ? ((0, jsx_runtime_1.jsxs)(styles_1.StateOverlay, { "aria-busy": "true", children: [(0, jsx_runtime_1.jsx)(styles_1.Skeleton, { style: { width: '100%' } }), (0, jsx_runtime_1.jsx)(styles_1.Skeleton, { style: { width: '95%' } }), (0, jsx_runtime_1.jsx)(styles_1.Skeleton, { style: { width: '90%' } })] })) : null, dataState === 'error' ? ((0, jsx_runtime_1.jsx)(styles_1.StateOverlay, { role: "alert", children: (0, jsx_runtime_1.jsx)("span", { style: { color: 'var(--dn)' }, children: "\u041E\u0448\u0438\u0431\u043A\u0430 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u0434\u0430\u043D\u043D\u044B\u0445" }) })) : null, dataState === 'empty' ? ((0, jsx_runtime_1.jsxs)(styles_1.StateOverlay, { children: [(0, jsx_runtime_1.jsx)("span", { children: "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0434\u043B\u044F \u043E\u0442\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F" }), (0, jsx_runtime_1.jsx)("span", { style: { fontSize: 10, color: 'var(--g500)' }, children: "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u0442\u0435 \u0438\u0437\u043C\u0435\u0440\u0435\u043D\u0438\u0435 \u0438 \u043C\u0435\u0442\u0440\u0438\u043A\u0443 \u0444\u0430\u043A\u0442\u0430" })] })) : null, (dataState === 'populated' ||
                        dataState === 'partial' ||
                        ...
                        })) })) : null, rows.length > 0 ? ((0, jsx_runtime_1.jsxs)(styles_1.CardFooter, { children: [(0, jsx_runtime_1.jsxs)(styles_1.FootHint, { children: [(0, jsx_runtime_1.jsx)(styles_1.Kbd, { children: "Click" }), (0, jsx_runtime_1.jsx)("span", { children: "\u0444\u0438\u043B\u044C\u0442\u0440" }), enableDetailModal ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { style: { color: 'var(--g500)' }, children: "\u00B7" }), (0, jsx_runtime_1.jsx)(styles_1.Kbd, { children: "Ctrl" }), (0, jsx_runtime_1.jsx)("span", { children: "+" }), (0, jsx_runtime_1.jsx)(styles_1.Kbd, { children: "Click" }), (0, jsx_runtime_1.jsx)("span", { children: "\u0434\u0435\u0442\u0430\u043B\u0438\u0437\u0430\u0446\u0438\u044F" })] })) : null] }), (0, jsx_runtime_1.jsxs)(styles_1.FootLegend, { children: [(0, jsx_runtime_1.jsxs)(styles_1.LegendItem, { children: [(0, jsx_runtime_1.jsx)(styles_1.LegendBar, {}), (0, jsx_runtime_1.jsx)("span", { children: "\u0444\u0430\u043A\u0442" })] }), (0, jsx_runtime_1.jsxs)(styles_1.LegendItem, { children: [(0, jsx_runtime_1.jsx)(styles_1.LegendTarget, {}), (0, jsx_runtime_1.jsx)("span", { children: "\u0446\u0435\u043B\u044C" })] }), (0, jsx_runtime_1.jsxs)(styles_1.LegendItem, { children: [(0, jsx_runtime_1.jsx)(styles_1.LegendBand, {}), (0, jsx_runtime_1.jsx)("span", { children: "\u0437\u043E\u043D\u0430" })] })] })] })) : null] }), tooltipState ? ((0, jsx_runtime_1.jsx)(Tooltip_1.default, { row: tooltipState.row, direction: direction, formatters: formatters, statusColor: statusColorVar(tooltipState.row.status), x: tooltipState.x, y: tooltipState.y, rootEl: rootRef.current, showDetailHint: enableDetailModal })) : null, modalRow ? ((0, jsx_runtime_1.jsx)(DetailModal_1.default, { row: modalRow, scaleMax: scaleMax, direction: direction, formatters: formatters, detailQueryParams: detailQueryParams, mockMode: mockModeEnabled, onClose: closeModal, rootEl: rootRef.current })) : null] }));
};
