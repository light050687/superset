...
exports.attachSparklines = attachSparklines;
 ...
 */
function attachSparklines(rows, sparkData, categoryColumn, metricFact, lastNPoints) {
    if (!sparkData.length || !categoryColumn || !metricFact)
        return rows;
    const metricLabel = (0, core_1.getMetricLabel)(metricFact);
    if (!metricLabel)
        return rows;
