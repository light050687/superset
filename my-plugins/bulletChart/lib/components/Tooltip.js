...
const BulletTooltip = ({ row, direction, formatters, statusColor, x, y, rootEl, showDetailHint, ink, surface, border, }) => {
    if (!rootEl)
        return null;
    ...
    const badTone = !badStores
        ...
        : badStores.pct > 50
            ...
            : badStores.pct > 30
                ? 'wn'
                : 'up';
    return (0, react_dom_1.createPortal)((0, jsx_runtime_1.jsxs)(styles_1.Tooltip, { role: "tooltip", style: { left, top, background: ink, color: surface, borderColor: border }, statusColor: statusColor, children: [(0, jsx_runtime_1.jsxs)(styles_1.TtHead, { children: [(0, jsx_runtime_1.jsx)(styles_1.TtStatus, {}), (0, jsx_runtime_1.jsxs)(styles_1.TtHeadBody, { children: [(0, jsx_runtime_1.jsx)(styles_1.TtName, { children: row.name }), row.stores != null ? ((0, jsx_runtime_1.jsx)(styles_1.TtSub, { children: (0, format_1.formatStoresCount)(row.stores) })) : null] })] }), (0, jsx_runtime_1.jsxs)(styles_1.TtRows, { children: [(0, jsx_runtime_1.jsxs)(styles_1.TtRow, { children: [(0, jsx_runtime_1.jsx)(styles_1.TtL, { children: "\u0424\u0430\u043A\u0442" }), (0, jsx_runtime_1.jsx)(styles_1.TtV, { tone: tone(row.status), children: formatters.value(row.rate) })] }), row.plan != null ? ((0, jsx_runtime_1.jsxs)(styles_1.TtRow, { children: [(0, jsx_runtime_1.jsx)(styles_1.TtL, { children: "\u041F\u043B\u0430\u043D (\u0446\u0435\u043B\u044C)" }), (0, jsx_runtime_1.jsx)(styles_1.TtV, { tone: "default", children: formatters.value(row.plan) })] })) : null, row.py != null ? ((0, jsx_runtime_1.jsxs)(styles_1.TtRow, { children: [(0, jsx_runtime_1.jsx)(styles_1.TtL, { children: "\u041F\u0440\u043E\u0448\u043B\u044B\u0439 \u0433\u043E\u0434" }), (0, jsx_runtime_1.jsx)(styles_1.TtV, { tone: "default", children: formatters.value(row.py) })] })) : null, row.deltaPlan != null ? ((0, jsx_runtime_1.jsxs)(styles_1.TtRow, { children: [(0, jsx_runtime_1.jsx)(styles_1.TtL, { children: "\u0394 \u043A \u043F\u043B\u0430\u043D\u0443" }), (0, jsx_runtime_1.jsx)(styles_1.TtV, { tone: deltaTone(row.deltaPlan, direction), children: formatters.deltaPP(row.deltaPlan) })] })) : null, row.deltaPy != null ? ((0, jsx_runtime_1.jsxs)(styles_1.TtRow, { children: [(0, jsx_runtime_1.jsx)(styles_1.TtL, { children: "\u0394 \u043A \u041F\u0413" }), (0, jsx_runtime_1.jsx)(styles_1.TtV, { tone: deltaTone(row.deltaPy, direction), children: formatters.deltaPP(row.deltaPy) })] })) : null, trend != null ? ((0, jsx_runtime_1.jsxs)(styles_1.TtRow, { children: [(0, jsx_runtime_1.jsx)(styles_1.TtL, { children: "\u0422\u0440\u0435\u043D\u0434" }), (0, jsx_runtime_1.jsxs)(styles_1.TtV, { tone: trend.tone, children: [trend.icon, " ", trend.text] })] })) : null, badStores != null ? ((0, jsx_runtime_1.jsxs)(styles_1.TtRow, { children: [(0, jsx_runtime_1.jsx)(styles_1.TtL, { children: "\u0425\u0443\u0436\u0435 \u043F\u043B\u0430\u043D\u0430" }), (0, jsx_runtime_1.jsxs)(styles_1.TtV, { tone: badTone, children: [badStores.count, " \u0438\u0437 ", badStores.total, " (", badStores.pct, "%)"] })] })) : null] }), (0, jsx_runtime_1.jsx)(styles_1.TtStatusText, { children: statusLabel(row.status, direction) })] }), rootEl);
};
