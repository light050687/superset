...
import { Kbd, Tooltip as TooltipBox, TtFoot, TtHead, TtL, TtName, TtRow, TtRows, TtStatus, TtStatusText, TtSub, TtV, } from '../styles';
    ...
    const badTone = !badStores
        ...
        : badStores.pct > 50
            ...
            : badStores.pct > 30
                ? 'wn'
                : 'up';
    return createPortal(_jsxs(TooltipBox, { role: "tooltip", style: { left, top }, statusColor: statusColor, children: [_jsxs(TtHead, { children: [_jsx(TtStatus, {}), _jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx(TtName, { children: row.name }), row.stores != null ? (_jsx(TtSub, { children: formatStoresCount(row.stores) })) : null] })] }), _jsxs(TtRows, { children: [_jsxs(TtRow, { children: [_jsx(TtL, { children: "\u0424\u0430\u043A\u0442" }), _jsx(TtV, { tone: tone(row.status), children: formatters.value(row.rate) })] }), row.plan != null ? (_jsxs(TtRow, { children: [_jsx(TtL, { children: "\u041F\u043B\u0430\u043D (\u0446\u0435\u043B\u044C)" }), _jsx(TtV, { tone: "default", children: formatters.value(row.plan) })] })) : null, row.py != null ? (_jsxs(TtRow, { children: [_jsx(TtL, { children: "\u041F\u0440\u043E\u0448\u043B\u044B\u0439 \u0433\u043E\u0434" }), _jsx(TtV, { tone: "default", children: formatters.value(row.py) })] })) : null, row.deltaPlan != null ? (_jsxs(TtRow, { children: [_jsx(TtL, { children: "\u0394 \u043A \u043F\u043B\u0430\u043D\u0443" }), _jsx(TtV, { tone: deltaTone(row.deltaPlan, direction), children: formatters.deltaPP(row.deltaPlan) })] })) : null, row.deltaPy != null ? (_jsxs(TtRow, { children: [_jsx(TtL, { children: "\u0394 \u043A \u041F\u0413" }), _jsx(TtV, { tone: deltaTone(row.deltaPy, direction), children: formatters.deltaPP(row.deltaPy) })] })) : null, trend != null ? (_jsxs(TtRow, { children: [_jsx(TtL, { children: "\u0422\u0440\u0435\u043D\u0434" }), _jsxs(TtV, { tone: trend.tone, children: [trend.icon, " ", trend.text] })] })) : null, badStores != null ? (_jsxs(TtRow, { children: [_jsx(TtL, { children: "\u0425\u0443\u0436\u0435 \u043F\u043B\u0430\u043D\u0430" }), _jsxs(TtV, { tone: badTone, children: [badStores.count, " \u0438\u0437 ", badStores.total, " (", badStores.pct, "%)"] })] })) : null] }), _jsx(TtStatusText, { children: statusLabel(row.status, direction) }), showDetailHint ? (_jsxs(TtFoot, { children: [_jsx(Kbd, { children: "Click" }), _jsx("span", { children: "\u0444\u0438\u043B\u044C\u0442\u0440" }), _jsx("span", { style: { color: 'var(--g400)' }, children: "\u00B7" }), _jsx(Kbd, { children: "Ctrl" }), _jsx("span", { children: "+" }), _jsx(Kbd, { children: "Click" }), _jsx("span", { children: "\u0434\u0435\u0442\u0430\u043B\u0438\u0437\u0430\u0446\u0438\u044F" })] })) : null] }), rootEl);
};
