...
import { Card, CardFooter, CardHead, CardSub, CardTitle, Controls, ErrorCaption, FootLegend, HintCaption, KEYFRAMES_CSS, LegendBand, LegendBar, LegendItem, LegendTarget, BulletList, Root, ROOT_CLASS, Skeleton, StateOverlay, TitleBlock, PartialBadge, MockBadge, StaleBar, } from './styles';
...
const BulletChartInner = props => {
    ...
    if (dataState === 'loading') {
        return (_jsxs(Root, { ref: rootRef, className: ROOT_CLASS, isDarkMode: isDarkMode, widthPx: width, heightPx: height, "data-theme": isDarkMode ? 'dark' : 'light', children: [_jsx("style", { dangerouslySetInnerHTML: { __html: KEYFRAMES_CSS } }), _jsxs(Card, { role: "region", "aria-label": headerText, "aria-busy": "true", "data-no-anim": "", children: [_jsx(CardHead, { children: _jsx(TitleBlock, { children: _jsxs(CardTitle, { children: [headerText, mockModeEnabled && _jsx(MockBadge, { children: "\u0422\u0415\u0421\u0422" })] }) }) }), _jsxs(StateOverlay, { "aria-busy": "true", children: [_jsx(Skeleton, { widthPct: 100 }), _jsx(Skeleton, { widthPct: 95 }), _jsx(Skeleton, { widthPct: 90 })] })] })] }));
    }
    return (_jsxs(Root, { ref: rootRef, className: ROOT_CLASS, isDarkMode: isDarkMode, widthPx: width, heightPx: height, "data-theme": isDarkMode ? 'dark' : 'light', children: [_jsx("style", { dangerouslySetInnerHTML: { __html: KEYFRAMES_CSS } }), _jsxs(Card, { role: "region", "aria-label": headerText, "data-info-hint-container": "", children: [dataState === 'stale' && _jsx(StaleBar, { "aria-hidden": "true" }), _jsxs(CardHead, { children: [_jsxs(TitleBlock, { children: [_jsxs(CardTitle, { children: [headerText, mockModeEnabled && _jsx(MockBadge, { children: "\u0422\u0415\u0421\u0422" }), dataState === 'partial' && (_jsx(PartialBadge, { title: "\u0427\u0430\u0441\u0442\u044C \u0434\u0430\u043D\u043D\u044B\u0445 \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0430", children: "\u0427\u0430\u0441\u0442\u0438\u0447\u043D\u043E" }))] }), _jsxs(CardSub, { children: [subheaderText ? _jsx("span", { children: subheaderText }) : null, totalStores != null ? (_jsxs(_Fragment, { children: [_jsx("span", { className: "dot" }), _jsx("span", { className: "strong", children: formatStoresCount(totalStores) })] })) : null] })] }), _jsxs(Controls, { children: [rows.length > 0 && (_jsxs(_Fragment, { children: [_jsx(SortMenu, { value: sortBy, onChange: setSortBy }), (() => {
                                                const opts = [
                                                ...
                                                return (_jsxs(_Fragment, { children: [_jsxs("button", { ref: statusTriggerRef, type: "button", className: "bc-status-dd-trigger", "aria-haspopup": "listbox", "aria-expanded": statusDdOpen, "aria-label": `Фильтр по статусу: ${cur.label}`, title: "\u0424\u0438\u043B\u044C\u0442\u0440 \u043F\u043E \u0441\u0442\u0430\u0442\u0443\u0441\u0443", onClick: () => setStatusDdOpen(v => !v), style: {
                                                                display: 'inline-flex',
                                                                alignItems: 'center',
                                                                gap: 6,
                                                                minHeight: 30,
                                                                ...
                                                                fontWeight: 600,
                                                                cursor: 'pointer',
                                                            }, children: [_jsx("span", { "aria-hidden": "true", style: { width: 8, height: 8, borderRadius: '50%', background: dotColor, flexShrink: 0 } }), _jsx("span", { children: cur.label }), _jsx("svg", { width: "9", height: "6", viewBox: "0 0 10 6", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", "aria-hidden": "true", children: _jsx("path", { d: "M1 1 L5 5 L9 1" }) })] }), statusDdOpen && createPortal(_jsx("div", { className: "bc-status-dd-portal", role: "listbox", "aria-label": "\u0424\u0438\u043B\u044C\u0442\u0440 \u043F\u043E \u0441\u0442\u0430\u0442\u0443\u0441\u0443", style: {
                                                                position: 'fixed',
                                                                ...
                                                                return (_jsxs("button", { type: "button", role: "option", "aria-selected": isOn, onClick: () => {
                                                                        ...
                                                                        e.currentTarget.style.background = 'transparent'; }, children: [_jsx("span", { "aria-hidden": "true", style: { width: 10, height: 10, borderRadius: '50%', background: oDot, flexShrink: 0, boxShadow: 'inset 0 0 0 1px rgba(0,0,0,0.04)' } }), _jsx("span", { children: o.label })] }, o.id));
                                                            }) }), document.body)] }));
                                            })()] })), _jsx(InfoHintTopRight, { children: _jsxs(InfoHint, { ariaLabel: "\u041F\u043E\u0434\u0441\u043A\u0430\u0437\u043A\u0430 \u043F\u043E \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044E", children: [enableDetailModal && (_jsxs(_Fragment, { children: [_jsxs("span", { className: "hi", children: [_jsx("kbd", { children: "Click" }), " bar \u2014 \u0434\u0435\u0442\u0430\u043B\u0438"] }), _jsx("span", { className: "hi-sep", "aria-hidden": "true" })] })), _jsx("span", { className: "hi", children: "Sort / Filter \u2014 controls \u0441\u0432\u0435\u0440\u0445\u0443" }), _jsx("span", { className: "hi-sep", "aria-hidden": "true" }), _jsxs("span", { className: "hi", children: [_jsx("kbd", { children: "Right Click" }), " \u2014 \u043C\u0435\u043D\u044E \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0439"] })] }) })] })] }), dataState === 'error' ? (_jsx(StateOverlay, { role: "alert", children: _jsx(ErrorCaption, { children: "\u041E\u0448\u0438\u0431\u043A\u0430 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u0434\u0430\u043D\u043D\u044B\u0445" }) })) : null, dataState === 'empty' ? (_jsxs(StateOverlay, { children: [_jsx("span", { children: "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0434\u043B\u044F \u043E\u0442\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F" }), _jsx(HintCaption, { children: "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u0442\u0435 \u0438\u0437\u043C\u0435\u0440\u0435\u043D\u0438\u0435 \u0438 \u043C\u0435\u0442\u0440\u0438\u043A\u0443 \u0444\u0430\u043A\u0442\u0430" })] })) : null, (dataState === 'populated' ||
                        dataState === 'partial' ||
                        dataState === 'stale') && rows.length > 0 ? (_jsx(BulletList, { role: "list", children: visibleRows.length === 0 && (filterBad || filterGood) ? (_jsx(StateOverlay, { children: _jsx("span", { children: filterBad && filterGood
                        ...
                        })) })) : null, _jsx(CardFooter, { children: rows.length > 0 && (_jsxs(FootLegend, { "aria-label": "\u0423\u0441\u043B\u043E\u0432\u043D\u044B\u0435 \u043E\u0431\u043E\u0437\u043D\u0430\u0447\u0435\u043D\u0438\u044F", children: [_jsxs(LegendItem, { children: [_jsx(LegendBar, {}), _jsx("span", { children: "\u0444\u0430\u043A\u0442" })] }), _jsxs(LegendItem, { children: [_jsx(LegendTarget, {}), _jsx("span", { children: "\u0446\u0435\u043B\u044C" })] }), _jsxs(LegendItem, { children: [_jsx(LegendBand, {}), _jsx("span", { children: "\u0437\u043E\u043D\u0430" })] })] })) })] }), tooltipState ? (_jsx(BulletTooltip, { row: tooltipState.row, direction: direction, formatters: formatters, statusColor: statusColorVar(tooltipState.row.status), x: tooltipState.x, y: tooltipState.y, rootEl: rootRef.current, showDetailHint: enableDetailModal, 
                /* Tooltip того же тона что Card surface (НЕ инверт).
                   Передаём theme-aware tokens: bg=surface, text=ink. */
                ink: isDarkMode ? DARK_TOKENS.s : LIGHT_TOKENS.s, surface: isDarkMode ? DARK_TOKENS.ink : LIGHT_TOKENS.ink, border: isDarkMode ? DARK_TOKENS.g700 : LIGHT_TOKENS.g300 })) : null, modalRow ? (_jsx(DetailModal, { row: modalRow, scaleMax: scaleMax, direction: direction, formatters: formatters, detailQueryParams: detailQueryParams, mockMode: mockModeEnabled, onClose: closeModal, rootEl: rootRef.current })) : null] }));
};
