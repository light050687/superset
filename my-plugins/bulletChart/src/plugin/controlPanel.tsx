...
const isSparklineEnabled = ({ controls }: ControlsMap): boolean =>
  controls?.sparkline_enabled?.value !== false;

const isDetailModalEnabled = ({ controls }: ControlsMap): boolean =>
  controls?.enable_detail_modal?.value !== false;
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Массив объектов: [{"id":"a","name":"Формат А","stores":10,"rate":2.3,' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Колонка, по которой группируются строки bullet-чарта. ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Опционально — количество элементов в категории ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Мини-тренд в правой части строки. Второй запрос на данные ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Определяет, что считать успехом: меньше плана (списания, потери) ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Размер «серой зоны» вокруг плана: ratio ∈ [1−tol, 1+tol] → warn. ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Пробел как разделитель тысяч, запятая как десятичный, ' +
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Колонка для drill-down модали. Например, «Название магазина», ' +
